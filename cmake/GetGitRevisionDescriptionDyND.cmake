...
function(get_git_head_revision _dir _refspecvar _hashvar)
	...
	while(NOT EXISTS "${GIT_DIR}")	# .git dir not found, search parent directories
		...
		set(GIT_DIR "${GIT_PARENT_DIR}/.git")
	endwhile()
    message(STATUS "Getting git information at: ${GIT_PARENT_DIR}")
	...
	configure_file("${_gitdescmoddir}/GetGitRevisionDescriptionDyND.cmake.in"
...
#		${hash}
	...
	if(NOT res EQUAL 0)
        message(STATUS "Git error output: ${out_err}")
