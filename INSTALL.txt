...
For the Python exposure, the following are also needed.
...
-------
    ...
    1a. Run CMake-gui. For the 'source code' folder, choose the
        ...
        2008. Double-click on the generated dynamicndarray.sln
        to open Visual Studio.

    1b. Start a command prompt window, and navigate to the
        dynamicndarray folder which is the root of the project.
    ...
    2. The RelWithDebInfo configuration is recommended for most
       purposes. The Debug configuration tries to link against
       a debug build of Python, even though that isn't necessarily
       desired.

    3. To install the Python module, explicitly build the INSTALL
       target.
