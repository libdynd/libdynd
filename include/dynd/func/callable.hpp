    ...
    */
    ...
    callable_instantiate_t get_wrapped_instantiate()
    {
      ...
      return KernelType::instantiate(
          ...
          data_size, reinterpret_cast<typename traits::data_type *>(data), ckb,
...
public:
      ...
      : m_value(empty(self_tp))
  {
    new (m_value.get_readwrite_originptr())
        callable_type_data(data_size, data_init, resolve_dst_type, instantiate);
  }
  ...
  */
  ...
  operator()(T &&... a)
  {
    ...
    typedef typename instantiate<
        detail::args, typename to<type_sequence<typename as_array<T>::type...>,
  ...
  template <typename KernelType>
  static typename std::enable_if<ndt::type::has_equivalent<KernelType>::value &&
