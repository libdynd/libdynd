...
namespace gfunc {
  ...
  struct dcs_size_of<short> {
    enum { value = sizeof(short) };
  };
  template <>
  struct dcs_size_of<int> {
    enum { value = sizeof(int) };
  };
  template <>
  struct dcs_size_of<long> {
    enum { value = sizeof(long) };
  };
  template <>
  struct dcs_size_of<long long> {
    enum { value = sizeof(long long) };
  };
  template <>
  ...
  struct dcs_size_of<unsigned short> {
    enum { value = sizeof(unsigned short) };
  };
  template <>
  struct dcs_size_of<unsigned int> {
    enum { value = sizeof(unsigned int) };
  };
  template <>
  struct dcs_size_of<unsigned long> {
    enum { value = sizeof(unsigned long) };
  };
  template <>
  struct dcs_size_of<unsigned long long> {
    enum { value = sizeof(unsigned long long) };
  };
  template <>
  ...
  struct dcs_size_of<double> {
    enum { value = sizeof(double) };
  };
  template <>
  struct dcs_size_of<complex<float>> {
    enum { value = sizeof(complex<float>) };
  };
  template <>
  struct dcs_size_of<complex<double>> {
    enum { value = sizeof(complex<double>) };
  };
  template <>
  struct dcs_size_of<array_preamble *> {
    enum { value = sizeof(array_preamble *) };
  };
  template <>
  struct dcs_size_of<const ndt::base_type *> {
    enum { value = sizeof(const ndt::base_type *) };
  };
  template <>
  struct dcs_size_of<string_type_data> {
    enum { value = sizeof(string_type_data) };
  };
  template <typename T, int N>
  struct dcs_size_of<T[N]> {
    enum { value = N * sizeof(T) };
  };
  ...
  struct dcs_offset_of {
    enum {
      partial_offset =
          dcs_offset_of<T0, T1, T2, T3, void>::value + dcs_size_of<T3>::value
    };
    ...
    enum {
      value = partial_offset +
              (((partial_offset & (field_align - 1)) == 0)
                   ? 0
                   : (field_align - (partial_offset & (field_align - 1))))
    };
  };
  ...
  struct dcs_offset_of<T0, T1, T2, T3, void> {
    enum {
      partial_offset =
          dcs_offset_of<T0, T1, T2, void, void>::value + dcs_size_of<T2>::value
    };
  ...
  struct dcs_offset_of<T0, T1, T2, void, void> {
    enum {
      partial_offset = dcs_offset_of<T0, T1, void, void, void>::value +
                       dcs_size_of<T1>::value
    };
  ...
  struct dcs_offset_of<T0, T1, void, void, void> {
    enum {
      partial_offset = dcs_offset_of<T0, void, void, void, void>::value +
                       dcs_size_of<T0>::value
    };
  ...
  struct make_parameter_type<T[N]> {
    inline static ndt::type make() { return ndt::type::make<T[N]>(); }
  };
  ...
  struct make_parameter_type<nd::array> {
    inline static ndt::type make() { return ndt::make_ndarrayarg(); }
  };
  template <>
  struct make_parameter_type<ndt::type> {
    inline static ndt::type make() { return ndt::make_type(); }
  };
  template <>
  ...
  struct unbox_param<bool> {
    inline static bool unbox(char *v) { return (*v != 0); }
  };
  template <typename T>
  ...
  namespace detail {
    ...
    struct callable_maker<R (*)(P0)> {
      ...
      static array_preamble *wrapper(const array_preamble *params, void *extra)
      {
        ...
        return box_result<R>::box(
            f(unbox_param<P0>::unbox(p + dcs_offset_of<T0>::value)));
      }
      ...
      static array_preamble *wrapper(const array_preamble *params, void *extra)
      {
        ...
        return box_result<R>::box(
            f(unbox_param<P0>::unbox(p + dcs_offset_of<T0>::value),
              ...
              unbox_param<P2>::unbox(p + dcs_offset_of<T0, T1, T2>::value),
              unbox_param<P3>::unbox(p + dcs_offset_of<T0, T1, T2, T3>::value),
              unbox_param<P4>::unbox(
                  p + dcs_offset_of<T0, T1, T2, T3, T4>::value)));
      }
      static ndt::type make_parameters_type(const char *name0,
                                            const char *name1,
                                            const char *name2,
  ...
  inline callable make_callable_with_default(FN *f, const char *name0,
                                             const D0 &default0)
  {
    ...
    return callable(pdt, &detail::callable_maker<FN *>::wrapper,
                    reinterpret_cast<void *>(f), 0, defaults);
  }
  ...
  {
    return callable(
        detail::callable_maker<FN *>::make_parameters_type(name0, name1),
                                             ...
                                             const D1 &default1)
  {
    ...
    defaults.flag_as_immutable();
    return callable(pdt, &detail::callable_maker<FN *>::wrapper,
                    reinterpret_cast<void *>(f), 1, defaults);
  }

  // Two parameters, two defaults
  template <typename FN, typename D0, typename D1>
  inline callable
  make_callable_with_default(FN *f, const char *name0, const char *name1,
                             const D0 &default0, const D1 &default1)
  {
    ndt::type pdt =
        detail::callable_maker<FN *>::make_parameters_type(name0, name1);
    nd::array defaults = nd::empty(pdt);
  ...
  {
    return callable(
        detail::callable_maker<FN *>::make_parameters_type(name0, name1, name2),
        &detail::callable_maker<FN *>::wrapper, reinterpret_cast<void *>(f));
  }
  ...
  inline callable
  make_callable_with_default(FN *f, const char *name0, const char *name1,
                             const char *name2, const D2 &default2)
  {
    ndt::type pdt =
        detail::callable_maker<FN *>::make_parameters_type(name0, name1, name2);
    nd::array defaults = nd::empty(pdt);
    ...
    defaults.flag_as_immutable();
    return callable(pdt, &detail::callable_maker<FN *>::wrapper,
                    reinterpret_cast<void *>(f), 2, defaults);
  }
  ...
  inline callable
  make_callable_with_default(FN *f, const char *name0, const char *name1,
                             const char *name2, const D1 &default1,
                             const D2 &default2)
  {
    ndt::type pdt =
        detail::callable_maker<FN *>::make_parameters_type(name0, name1, name2);
  ...
  inline callable
  make_callable_with_default(FN *f, const char *name0, const char *name1,
                             const char *name2, const D0 &default0,
  ...
  {
    return callable(detail::callable_maker<FN *>::make_parameters_type(
  ...
  make_callable_with_default(FN *f, const char *name0, const char *name1,
                             ...
                             const D3 &default3)
  {
    ndt::type pdt = detail::callable_maker<FN *>::make_parameters_type(
        name0, name1, name2, name3);
    nd::array defaults = nd::empty(pdt);
    ...
    defaults.flag_as_immutable();
    return callable(pdt, &detail::callable_maker<FN *>::wrapper,
                    reinterpret_cast<void *>(f), 3, defaults);
  }
