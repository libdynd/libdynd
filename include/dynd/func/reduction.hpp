...
namespace nd {
  namespace functional {
     ...
     *
     * This lifts a unary_operation ckernel, which accumulates an individual
     *value
     ...
     * \param reduction_identity  Either a NULL array if there is no identity,
     *or
     *                            a value that the output can be initialized to
     *at
     *                            the start.
    ...
    size_t make_lifted_reduction_ckernel(
        ...
        bool associative, bool commutative, bool right_associative,
        const nd::array &reduction_identity, dynd::kernel_request_t kernreq,
