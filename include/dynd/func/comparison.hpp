...
namespace nd {
  ...
  decltype(auto) make_comparison_children()
  {
  ...
  template <callable &Func, template <type_id_t...> class KernelType>
  decltype(auto) make_comparison_children()
  {
    typedef type_id_sequence<bool_id, int8_id, int16_id, int32_id, int64_id, uint8_id, uint16_id, uint32_id, uint64_id,
                             float32_id, float64_id> numeric_ids;
    ...
    callable self = functional::call<Func>(ndt::type("(Any, Any) -> Any"));
    ...
    dispatcher.insert({{option_id, option_id}, make_callable<new_option_comparison_callable<Func, true, true>>()});
  ...
  struct comparison_operator : declfunc<FuncType> {
    static decltype(auto) make_children() { return make_comparison_children<FuncType, KernelType>(); }

    static callable make()
    {
      return make_callable<comparison_dispatch_callable>(ndt::type("(Any, Any) -> Any"), FuncType::make_children());
    }
  };
