...
namespace ndt {
  ...
  public:
    base_memory_type(type_id_t id, type_id_t base_id, const type &element_tp, size_t data_size, size_t alignment,
                     size_t storage_arrmeta_offset, uint32_t flags)
        : base_type(id, base_id, data_size, alignment, flags, storage_arrmeta_offset + element_tp.get_arrmeta_size(),
