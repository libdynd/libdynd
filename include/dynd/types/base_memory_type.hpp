...
namespace ndt {
  ...
  public:
    base_memory_type(type_id_t new_id, type_id_t type_id, const type &element_tp, size_t data_size, size_t alignment,
                     size_t storage_arrmeta_offset, uint32_t flags)
        : base_type(new_id, type_id, data_size, alignment, flags,
