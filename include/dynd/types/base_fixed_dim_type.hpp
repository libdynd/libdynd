...
namespace ndt {
  ...
  public:
    ...
    base_fixed_dim_type(type_id_t new_id, const type &element_tp = make_type<any_kind_type>())
        : base_dim_type(new_id, fixed_dim_id, element_tp, 0, element_tp.get_data_alignment(), sizeof(size_stride_t),
