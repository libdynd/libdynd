...
typedef type_id_sequence<int8_type_id, int16_type_id, int32_type_id, int64_type_id, int128_type_id> signed_int_type_ids;
typedef type_id_sequence<bool_type_id, uint8_type_id, uint16_type_id, uint32_type_id, uint64_type_id, uint128_type_id> unsigned_int_type_ids;
typedef type_id_sequence<float16_type_id, float32_type_id, float64_type_id, float128_type_id> floating_type_ids;
typedef type_id_sequence<complex_float32_type_id, complex_float64_type_id> complex_floating_type_ids;

typedef join<signed_int_type_ids, unsigned_int_type_ids>::type integral_type_ids;
typedef join<integral_type_ids, floating_type_ids>::type real_type_ids;
typedef join<real_type_ids, complex_floating_type_ids>::type complex_type_ids;
