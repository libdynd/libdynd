...
namespace ndt {
  ...
  public:
     ...
     * (value_type()) */
    virtual void make_operand_to_value_assignment_kernel(nd::kernel_builder *ckb, intptr_t ckb_offset,
    ...
    virtual void make_value_to_operand_assignment_kernel(nd::kernel_builder *ckb, intptr_t ckb_offset,
                                                         const char *dst_arrmeta, const char *src_arrmeta,
                                                         kernel_request_t kernreq,
                                                         const eval::eval_context *ectx) const;
