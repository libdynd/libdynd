...
namespace ndt {
  ...
  public:
    unary_expr_type(const type &value_type, const type &operand_type, const expr_kernel_generator *kgen);
     ...
     */
    static type make(const type &value_tp, const type &operand_tp, const expr_kernel_generator *kgen)
    {
