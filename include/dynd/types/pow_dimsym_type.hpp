...
namespace ndt {
  ...
  public:
    pow_dimsym_type(type_id_t new_id, const type &base_tp, const std::string &exponent, const type &element_type)
        : base_dim_type(new_id, pow_dimsym_id, element_type, 0, 1, 0, type_flag_symbolic, false), m_base_tp(base_tp),
          m_exponent(exponent) {
