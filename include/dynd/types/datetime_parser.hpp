 ...
 */
DYND_API bool string_to_datetime(const char *begin, const char *end, date_parse_order_t ambig, int century_window,
 ...
 */
DYND_API bool parse_datetime(const char *&begin, const char *end, date_parse_order_t ambig, int century_window,
