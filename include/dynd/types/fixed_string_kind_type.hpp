...
namespace ndt {
  ...
  public:
    fixed_string_kind_type(type_id_t new_id) : base_string_type(new_id, fixed_string_id, 0, 0, type_flag_symbolic, 0) {}
  ...
  template <>
  struct id_of<fixed_string_kind_type> : std::integral_constant<type_id_t, fixed_string_id> {};
