...
namespace ndt {
  ...
  public:
    base_string_type(type_id_t type_id, type_kind_t type_kind, size_t data_size, size_t alignment, flags_type flags,
                     size_t arrmeta_size)
        : base_type(type_id, type_kind, data_size, alignment, flags, arrmeta_size, 0, 0)
    {
    }

    base_string_type(type_id_t type_id, size_t data_size, size_t alignment, flags_type flags, size_t arrmeta_size)
        : base_type(type_id, string_kind, data_size, alignment, flags, arrmeta_size, 0, 0)
    {
    }
