...
namespace ndt {
  ...
  public:
    base_string_type(type_id_t id, size_t data_size, size_t alignment, uint32_t flags, size_t arrmeta_size)
        : base_type(id, data_size, alignment, flags, arrmeta_size, 0, 0) {}
