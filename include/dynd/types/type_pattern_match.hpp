...
namespace ndt {
   ...
   *                  dimension of the type only is what is relevant.
   */
  bool pattern_match_dims(const ndt::type &concrete,
  ...
  inline bool pattern_match_dims(const ndt::type &concrete,
                                 const ndt::type &pattern,
                                 std::map<nd::string, ndt::type> &typevars,
                                 ndt::type &out_concrete_dtype,
                                 ndt::type &out_pattern_dtype)
  {
    return pattern_match_dims(concrete, NULL, pattern, typevars,
