...
namespace ndt {
  ...
  public:
    base_dim_type(type_id_t new_id, type_id_t id, const type &element_tp, size_t data_size, size_t data_alignment,
                  size_t element_arrmeta_offset, uint32_t flags, bool strided)
        : base_type(new_id, id, data_size, data_alignment, flags | type_flag_indexable,
