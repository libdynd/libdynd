...
namespace nd {
  ...
  public:
    ...
    ndt::type resolve(base_callable *DYND_UNUSED(caller), char *DYND_UNUSED(data), call_graph &cg,
      ...
      cg.emplace_back([i, arrmeta_offset](kernel_builder &kb, kernel_request_t kernreq, const char *dst_arrmeta,
        ...
        kb(kernreq | kernel_request_data_only, dst_arrmeta, 1, field_metadata);
      });
  ...
  public:
    get_array_field_callable(intptr_t i)
        : base_callable(ndt::callable_type::make(ndt::type("Any"), ndt::make_type<ndt::tuple_type>(),
                                                 ndt::make_type<ndt::struct_type>("self"))),
          m_i(i) {}
    ...
    ndt::type resolve(base_callable *DYND_UNUSED(caller), char *DYND_UNUSED(data), call_graph &cg,
      ...
      cg.emplace_back([ kwds, m_i = m_i ](kernel_builder & kb, kernel_request_t kernreq,
                                          const char *DYND_UNUSED(dst_arrmeta), size_t DYND_UNUSED(nsrc),
                                          const char *const *DYND_UNUSED(src_arrmeta)) {
        kb.emplace_back<get_array_field_kernel>(kernreq, kwds[0], m_i);
      });
