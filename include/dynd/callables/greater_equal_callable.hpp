...
namespace nd {
  ...
  class greater_equal_callable : public base_instantiable_callable<greater_equal_kernel<Arg0ID, Arg1ID>> {
  public:
    greater_equal_callable()
        : base_instantiable_callable<greater_equal_kernel<Arg0ID, Arg1ID>>(
