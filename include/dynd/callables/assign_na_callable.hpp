    ...
    ndt::type resolve(base_callable *DYND_UNUSED(caller), char *DYND_UNUSED(data), call_graph &cg,
      ...
      case bool_id:
        cg.emplace_back([](kernel_builder &kb, kernel_request_t kernreq, const char *DYND_UNUSED(dst_arrmeta),
          ...
          kb.emplace_back<assign_na_kernel<bool_id>>(kernreq);
        });
        break;
      case int8_id:
        cg.emplace_back([](kernel_builder &kb, kernel_request_t kernreq, const char *DYND_UNUSED(dst_arrmeta),
                           size_t DYND_UNUSED(nsrc), const char *const *DYND_UNUSED(src_arrmeta)) {
          kb.emplace_back<assign_na_kernel<int8_id>>(kernreq);
        });
        break;
      case int16_id:
        cg.emplace_back([](kernel_builder &kb, kernel_request_t kernreq, const char *DYND_UNUSED(dst_arrmeta),
                           size_t DYND_UNUSED(nsrc), const char *const *DYND_UNUSED(src_arrmeta)) {
          kb.emplace_back<assign_na_kernel<int16_id>>(kernreq);
        });
        break;
      case int32_id:
        cg.emplace_back([](kernel_builder &kb, kernel_request_t kernreq, const char *DYND_UNUSED(dst_arrmeta),
                           size_t DYND_UNUSED(nsrc), const char *const *DYND_UNUSED(src_arrmeta)) {
          kb.emplace_back<assign_na_kernel<int32_id>>(kernreq);
        });
        break;
      case int64_id:
        cg.emplace_back([](kernel_builder &kb, kernel_request_t kernreq, const char *DYND_UNUSED(dst_arrmeta),
                           size_t DYND_UNUSED(nsrc), const char *const *DYND_UNUSED(src_arrmeta)) {
          kb.emplace_back<assign_na_kernel<int64_id>>(kernreq);
        });
        break;
      case int128_id:
        cg.emplace_back([](kernel_builder &kb, kernel_request_t kernreq, const char *DYND_UNUSED(dst_arrmeta),
                           size_t DYND_UNUSED(nsrc), const char *const *DYND_UNUSED(src_arrmeta)) {
          kb.emplace_back<assign_na_kernel<int128_id>>(kernreq);
        });
        break;
      case float32_id:
        cg.emplace_back([](kernel_builder &kb, kernel_request_t kernreq, const char *DYND_UNUSED(dst_arrmeta),
