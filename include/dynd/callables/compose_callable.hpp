  ...
  namespace functional {
    ...
    public:
      ...
      void instantiate(call_node *DYND_UNUSED(node), char *data, kernel_builder *ckb, const ndt::type &dst_tp,
        ...
        m_first->instantiate(nullptr, data, ckb, m_buffer_tp, self->buffer_arrmeta.get(), 1, src_tp, src_arrmeta,
        ...
        m_second->instantiate(nullptr, data, ckb, dst_tp, dst_arrmeta, 1, &m_buffer_tp, &buffer_arrmeta,
                              kernreq | kernel_request_data_only, nkwd, kwds, tp_vars);
        ckb_offset = ckb->size();
      }
    };
