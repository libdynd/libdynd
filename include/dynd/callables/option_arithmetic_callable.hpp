...
namespace nd {
  ...
  template <>
  class option_arithmetic_callable<true, false> : public base_callable {
  public:
    ...
    ndt::type resolve(base_callable *caller, char *DYND_UNUSED(data), call_graph &cg, const ndt::type &res_tp,
      ...
      ndt::type res_value_tp = caller->resolve(this, nullptr, cg, res_tp, 2, src_value_tp, nkwd, kwds, tp_vars);
  ...
  template <>
  class option_arithmetic_callable<false, true> : public base_callable {
  public:
    option_arithmetic_callable() : base_callable(ndt::type("(Scalar, ?Scalar) -> ?Scalar")) {}
    ...
    ndt::type resolve(base_callable *caller, char *DYND_UNUSED(data), call_graph &cg, const ndt::type &dst_tp,
      ...
      ndt::type res_value_tp = caller->resolve(this, nullptr, cg, dst_tp, 2, src_value_tp, nkwd, kwds, tp_vars);
      return assign_na->resolve(this, nullptr, cg, ndt::make_type<ndt::option_type>(res_value_tp), 0, nullptr, nkwd,
                                kwds, tp_vars);
    }
  };
  ...
  template <>
  class option_arithmetic_callable<true, true> : public base_callable {
  public:
    option_arithmetic_callable() : base_callable(ndt::type("(?Scalar, ?Scalar) -> ?Scalar")) {}
