...
namespace nd {
  ...
  public:
    ...
    void instantiate(call_node *DYND_UNUSED(node), char *data, kernel_builder *ckb, const ndt::type &dst_tp,
      ...
      is_na->instantiate(nullptr, data, ckb, dst_tp, dst_arrmeta, nsrc, src_tp + I, src_arrmeta + I,
      ...
      assign_na->instantiate(nullptr, data, ckb, ndt::make_type<ndt::option_type>(ndt::make_type<bool1>()), nullptr, 0,
                             nullptr, nullptr, kernel_request_single, nkwd, kwds, tp_vars);

      child_offsets[1] = ckb->size() - self_offset;
      m_child->instantiate(nullptr, data, ckb, dst_tp.extended<ndt::option_type>()->get_value_type(), dst_arrmeta, nsrc,
  ...
  public:
    ...
    void instantiate(call_node *DYND_UNUSED(node), char *data, kernel_builder *ckb, const ndt::type &dst_tp,
      ...
      is_na->instantiate(nullptr, data, ckb, dst_tp, dst_arrmeta, nsrc, &src_tp[0], &src_arrmeta[0],
                         kernel_request_single, nkwd, kwds, tp_vars);
      ckb_offset = ckb->size();
      ...
      cmp.get()->instantiate(nullptr, data, ckb, dst_tp.extended<ndt::option_type>()->get_value_type(), dst_arrmeta,
