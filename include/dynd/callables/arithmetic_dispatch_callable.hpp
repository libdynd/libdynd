...
namespace nd {
  ...
  public:
    arithmetic_dispatch_callable(const ndt::type &tp, const dispatcher<Func, 1, callable> &dispatcher)
  ...
  class arithmetic_dispatch_callable<Func, 2> : public base_dispatch_callable {
    dispatcher<Func, 2, callable> m_dispatcher;

  public:
    arithmetic_dispatch_callable(const ndt::type &tp, const dispatcher<Func, 2, callable> &dispatcher)
        : base_dispatch_callable(tp), m_dispatcher(dispatcher) {}
