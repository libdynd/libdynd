...
namespace nd {
  ...
  public:
    ...
    ndt::type resolve(base_callable *DYND_UNUSED(caller), char *DYND_UNUSED(data), call_graph &cg,
      ...
      cg.push_back([dst_id, string_size, string_encoding](
          call_node *&DYND_UNUSED(node), kernel_builder * ckb, kernel_request_t kernreq, const char *dst_arrmeta,
  ...
  public:
    ...
    ndt::type resolve(base_callable *DYND_UNUSED(caller), char *DYND_UNUSED(data), call_graph &cg,
      ...
      cg.push_back([error_mode](call_node *&DYND_UNUSED(node), kernel_builder * ckb, kernel_request_t kernreq,
                                const char *DYND_UNUSED(dst_arrmeta), size_t DYND_UNUSED(nsrc),
                                const char *const *src_arrmeta) {
        ckb->emplace_back<
  ...
  public:
    ...
    ndt::type resolve(base_callable *DYND_UNUSED(caller), char *DYND_UNUSED(data), call_graph &cg,
      ...
      cg.push_back([dst_data_size, dst_encoding, src0_encoding, error_mode](
          call_node *&DYND_UNUSED(node), kernel_builder * ckb, kernel_request_t kernreq,
          const char *DYND_UNUSED(dst_arrmeta), size_t DYND_UNUSED(nsrc), const char *const *DYND_UNUSED(src_arrmeta)) {
  ...
  public:
    ...
    ndt::type resolve(base_callable *DYND_UNUSED(caller), char *DYND_UNUSED(data), call_graph &cg,
      ...
      case float32_id:
      case float64_id:
        cg.push_back([tid, error_mode](call_node *&DYND_UNUSED(node), kernel_builder *ckb, kernel_request_t kernreq,
                                       const char *DYND_UNUSED(dst_arrmeta), size_t DYND_UNUSED(nsrc),
                                       const char *const *DYND_UNUSED(src_arrmeta)) {
