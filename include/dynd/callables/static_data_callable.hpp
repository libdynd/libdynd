...
namespace nd {
  ...
  struct static_data_callable : base_callable {
    ...
    static_data_callable(const ndt::type &tp, kernel_targets_t targets, const volatile char *ir,
        ...
        : base_callable(tp, targets, ir, data_init, resolve_dst_type, instantiate), static_data(static_data)
    {
    }
  };
