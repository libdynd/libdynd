...
namespace gfunc {
      ...
      static void set(const ndt::type &paramtype, char *arrmeta, char *data, const nd::array &value)
      {
        if (paramtype.get_type_id() == ndarrayarg_type_id) {
          *reinterpret_cast<const array_preamble **>(data) = value.get();
          ...
          typed_data_assign(paramtype, arrmeta, data, value.get_type(), value.get_arrmeta(), value.get()->ptr);
        }
      }
    };
      ...
      if (m_first_default_parameter <= 0) {
        ...
        for (intptr_t i = 0; i < parameter_count; ++i) {
          ...
          typed_data_copy(fsdt->get_field_type(i), params.get_arrmeta() + arrmeta_offset,
                          params.get()->ptr + data_offset, m_default_parameters.get_arrmeta() + arrmeta_offset,
  ...
  inline nd::array callable::call(const T &p0) const
  {
    ...
    detail::callable_argument_setter<T>::set(
        ...
        params.get()->ptr + fsdt->get_data_offsets(params.get_arrmeta())[0], p0);
    return call_generic(params);
  }
  ...
  inline nd::array callable::call(const T0 &p0, const T1 &p1) const
  {
    ...
    detail::callable_argument_setter<T1>::set(
        ...
        params.get()->ptr + fsdt->get_data_offsets(params.get_arrmeta())[1], p1);
    return call_generic(params);
  }
  ...
  inline nd::array callable::call(const T0 &p0, const T1 &p1, const T2 &p2) const
  {
    ...
    detail::callable_argument_setter<T2>::set(
        ...
        params.get()->ptr + fsdt->get_data_offsets(params.get_arrmeta())[2], p2);
    return call_generic(params);
  }
  ...
  inline nd::array callable::call(const T0 &p0, const T1 &p1, const T2 &p2, const T3 &p3) const
  {
    ...
    detail::callable_argument_setter<T3>::set(
        ...
        params.get()->ptr + fsdt->get_data_offsets(params.get_arrmeta())[3], p3);
    return call_generic(params);
  }
  ...
  inline nd::array callable::call(const T0 &p0, const T1 &p1, const T2 &p2, const T3 &p3, const T4 &p4) const
  {
    ...
    detail::callable_argument_setter<T4>::set(
        ...
        params.get()->ptr + fsdt->get_data_offsets(params.get_arrmeta())[4], p4);
    return call_generic(params);
  }
