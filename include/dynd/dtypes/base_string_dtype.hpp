...
public:
    inline base_string_dtype(type_id_t type_id, size_t data_size, size_t alignment, flags_type flags)
        : base_dtype(type_id, string_kind, data_size, alignment, flags, 0)
    {}
