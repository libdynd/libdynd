...
class property_dtype : public base_expression_type {
...
public:
     ...
     */
    property_dtype(const ndt::type& operand_type, const std::string& property_name,
     ...
     *                        the index from the name.
     */
    property_dtype(const ndt::type& value_type, const ndt::type& operand_type, const std::string& property_name,
                size_t property_index = std::numeric_limits<size_t>::max());
 ...
 */
inline ndt::type make_property_dtype(const ndt::type& operand_type, const std::string& property_name,
                size_t property_index = std::numeric_limits<size_t>::max()) {
    return ndt::type(new property_dtype(operand_type, property_name, property_index), false);
}
 ...
 */
inline ndt::type make_reversed_property_dtype(const ndt::type& value_type,
                const ndt::type& operand_type, const std::string& property_name,
                size_t property_index = std::numeric_limits<size_t>::max()) {
    return ndt::type(new property_dtype(value_type, operand_type, property_name, property_index), false);
}
