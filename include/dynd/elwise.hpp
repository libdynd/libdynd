...
\
        ...
        ckd.instantiate_func = &detail::elwise_ckernel_instantiator<R (*)(DYND_PP_JOIN_1((,), \
            DYND_PP_META_NAME_RANGE(A, NSRC)))>::instantiate; \
        ckd.free_func = NULL; \
\
        ckernel_builder ckb; \
...
\
        ...
        ckd.data_dynd_types = data_dynd_types; \
        ckd.data_ptr = reinterpret_cast<void *>(func); \
        ckd.instantiate_func = &detail::elwise_ckernel_instantiator<void (*)(R &, DYND_PP_JOIN_1((,), \
            DYND_PP_META_NAME_RANGE(A, NSRC)))>::instantiate; \
        ckd.free_func = NULL; \
\
        ckernel_builder ckb; \
...
template<typename T>
inline nd::array elwise(const T &obj, const nd::array& a, const nd::array& b)
{
