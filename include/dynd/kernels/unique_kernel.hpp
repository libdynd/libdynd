...
namespace nd {
  ...
  struct unique_kernel : base_kernel<unique_kernel> {
                                ...
                                const std::map<std::string, ndt::type> &tp_vars)
    {
      ...
      return equal.get()->instantiate(equal.get()->static_data, equal.get()->data_size, data, ckb, ckb_offset,
                                      ndt::type::make<bool1>(), NULL, 2, equal_src_tp, NULL, kernel_request_single,
