 ...
 */
DYND_API size_t make_fixed_string_comparison_kernel(kernel_builder *ckb, intptr_t ckb_offset, size_t string_size,
 ...
 * \param encoding  The encoding of the string.
 */
DYND_API size_t make_string_comparison_kernel(kernel_builder *ckb, intptr_t ckb_offset, string_encoding_t encoding,
 ...
 *
 */
DYND_API size_t make_general_string_comparison_kernel(kernel_builder *ckb, intptr_t ckb_offset,
