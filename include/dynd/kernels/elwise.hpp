    ...
    struct elwise_virtual_ck : base_virtual_kernel<elwise_virtual_ck<N>> {
      ...
      */
      ...
      static intptr_t instantiate(
          ...
          char *static_data, size_t DYND_UNUSED(data_size), char *data,
        ...
        if (dst_ndim == 0) {
          ...
          if (i == nsrc) {
            ...
            return child.get()->instantiate(
                child.get(), child_tp, child.get()->static_data, 0, NULL, ckb,
          ...
          const std::map<dynd::nd::string, ndt::type> &tp_vars)
      {
        ...
        if (!finished) {
          return nd::functional::elwise_virtual_ck<N>::instantiate(
              self, self_tp, const_cast<char *>(self->static_data), 0, data,
              ckb, ckb_offset, child_dst_tp, child_dst_arrmeta, nsrc,
        ...
        return child.get()->instantiate(
            child.get(), child_tp, child.get()->static_data, 0, NULL, ckb,
            ckb_offset, child_dst_tp, child_dst_arrmeta, nsrc, child_src_tp,
          ...
          const std::map<dynd::nd::string, ndt::type> &tp_vars)
      {
        ...
        if (!finished) {
          return nd::functional::elwise_virtual_ck<0>::instantiate(
              self, self_tp, static_data, 0, data, ckb, ckb_offset,
        ...
        return child.get()->instantiate(
            child.get(), child_tp, child.get()->static_data, 0, NULL, ckb,
            ckb_offset, child_dst_tp, child_dst_arrmeta, nsrc, NULL, NULL,
            kernreq, ectx, kwds, tp_vars);
      }
    };
