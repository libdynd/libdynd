  ...
  struct option_comparison_kernel<FuncType, true, false>
                                ...
                                intptr_t nkwd, const array *kwds, const std::map<std::string, ndt::type> &tp_vars)
    {
      ...
      option_comparison_kernel *self =
          option_comparison_kernel::get_self(reinterpret_cast<kernel_builder *>(ckb), option_comp_offset);
      ...
      self = option_comparison_kernel::get_self(reinterpret_cast<kernel_builder *>(ckb), option_comp_offset);
