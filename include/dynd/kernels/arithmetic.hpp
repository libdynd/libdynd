  ...
  struct option_arithmetic_kernel<FuncType, true, false>
                                ...
                                intptr_t nkwd, const array *kwds, const std::map<std::string, ndt::type> &tp_vars)
    {
      ...
      option_arithmetic_kernel *self =
          option_arithmetic_kernel::get_self(reinterpret_cast<kernel_builder *>(ckb), option_arith_offset);
      ...
      self = option_arithmetic_kernel::get_self(reinterpret_cast<kernel_builder *>(ckb), option_arith_offset);
