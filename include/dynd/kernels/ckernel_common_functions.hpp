...
namespace kernels {
   ...
   */
  DYND_API void unary_as_expr_adapter_single_ckernel(char *dst, const char *const *src, ckernel_prefix *ckp);

  /**
   * An expr strided ckernel function which adapts a child
   * unary strided ckernel.
   */
  DYND_API void unary_as_expr_adapter_strided_ckernel(char *dst, intptr_t dst_stride, const char *const *src,
   ...
   */
  DYND_API void expr_as_unary_adapter_single_ckernel(char *dst, const char *src, ckernel_prefix *ckp);
   ...
   * must itself be unary as well.
   */
  DYND_API void expr_as_unary_adapter_strided_ckernel(char *dst, intptr_t dst_stride, const char *src,
                                                      intptr_t src_stride, size_t count, ckernel_prefix *ckp);
   ...
   */
  DYND_API intptr_t wrap_expr_as_unary_ckernel(void *ckb, intptr_t ckb_offset, kernel_request_t kernreq);
