          ...
          const nd::array &kwds, const std::map<nd::string, ndt::type> &tp_vars)
      {
        ...
        case assign_error_nocheck:
          return assignment_kernel<
              ...
              assign_error_nocheck>::instantiate(self, self_tp, data_size, data,
        ...
        case assign_error_overflow:
          return assignment_kernel<
              DstTypeID, DstTypeKind, Src0TypeID, Src0TypeKind,
              assign_error_overflow>::instantiate(self, self_tp, data_size,
                                                  data, ckb, ckb_offset, dst_tp,
                                                  dst_arrmeta, nsrc, src_tp,
                                                  src_arrmeta, kernreq, ectx,
                                                  kwds, tp_vars);
        case assign_error_fractional:
          return assignment_kernel<
              DstTypeID, DstTypeKind, Src0TypeID, Src0TypeKind,
              assign_error_fractional>::instantiate(self, self_tp, data_size,
                                                    data, ckb, ckb_offset,
        ...
        case assign_error_inexact:
          return assignment_kernel<
              DstTypeID, DstTypeKind, Src0TypeID, Src0TypeKind,
              assign_error_inexact>::instantiate(self, self_tp, data_size, data,
                                                 ckb, ckb_offset, dst_tp,
                                                 dst_arrmeta, nsrc, src_tp,
                                                 src_arrmeta, kernreq, ectx,
                                                 kwds, tp_vars);
