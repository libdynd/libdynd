...
namespace nd {
  ...
  namespace detail {
    ...
    template <type_id_t DstTypeID, type_id_t DstBaseID, type_id_t Src0TypeID, type_kind_t Src0TypeKind,
    ...
    struct assignment_virtual_kernel
        : base_kernel<assignment_virtual_kernel<DstTypeID, DstBaseID, Src0TypeID, Src0TypeKind>> {
                              ...
                              const nd::array *kwds, const std::map<std::string, ndt::type> &tp_vars)
      {
        ...
        case assign_error_nocheck:
          assignment_kernel<DstTypeID, DstBaseID, Src0TypeID, Src0TypeKind, assign_error_nocheck>::instantiate(
              static_data, data, ckb, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq, nkwd, kwds, tp_vars);
          break;
        case assign_error_overflow:
          assignment_kernel<DstTypeID, DstBaseID, Src0TypeID, Src0TypeKind, assign_error_overflow>::instantiate(
              static_data, data, ckb, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq, nkwd, kwds, tp_vars);
          break;
        case assign_error_fractional:
          assignment_kernel<DstTypeID, DstBaseID, Src0TypeID, Src0TypeKind, assign_error_fractional>::instantiate(
              static_data, data, ckb, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq, nkwd, kwds, tp_vars);
          break;
        case assign_error_inexact:
          assignment_kernel<DstTypeID, DstBaseID, Src0TypeID, Src0TypeKind, assign_error_inexact>::instantiate(
              static_data, data, ckb, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq, nkwd, kwds, tp_vars);
          break;
        default:
    ...
    template <type_id_t DstTypeID, type_id_t DstBaseID, type_id_t Src0TypeID, type_kind_t Src0TypeKind,
              assign_error_mode ErrorMode>
    struct assignment_kernel<DstTypeID, DstBaseID, Src0TypeID, Src0TypeKind, ErrorMode>
        : base_kernel<assignment_kernel<DstTypeID, DstBaseID, Src0TypeID, Src0TypeKind, ErrorMode>, 1> {
    ...
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, complex_kind, assign_error_nocheck>
        : base_kernel<assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, complex_kind, assign_error_nocheck>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, complex_kind, assign_error_nocheck>
        : base_kernel<assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, complex_kind, assign_error_nocheck>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, complex_kind, assign_error_nocheck>
        : base_kernel<assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, complex_kind, assign_error_nocheck>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, sint_kind, assign_error_nocheck>
        : base_kernel<assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, sint_kind, assign_error_nocheck>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, sint_kind, assign_error_inexact>
        : base_kernel<assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, sint_kind, assign_error_inexact>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, sint_kind, assign_error_overflow>
        : assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, sint_kind, assign_error_nocheck> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, sint_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, sint_kind, assign_error_nocheck> {
    };

    // Anything -> boolean with no checking
    template <type_id_t Src0TypeID, type_kind_t Src0TypeKind>
    struct assignment_kernel<bool_id, bool_kind_id, Src0TypeID, Src0TypeKind, assign_error_nocheck>
        : base_kernel<assignment_kernel<bool_id, bool_kind_id, Src0TypeID, Src0TypeKind, assign_error_nocheck>, 1> {
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, uint_kind, assign_error_inexact>
        : base_kernel<assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, uint_kind, assign_error_inexact>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, uint_kind, assign_error_overflow>
        : assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, uint_kind, assign_error_nocheck> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, uint_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, uint_kind, assign_error_nocheck> {
    };

    // Unsigned int -> complex floating point with no checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, uint_kind, assign_error_nocheck>
        : base_kernel<assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, uint_kind, assign_error_nocheck>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, uint_kind, assign_error_inexact>
        : base_kernel<assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, uint_kind, assign_error_inexact>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, uint_kind, assign_error_overflow>
        : assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, uint_kind, assign_error_nocheck> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, uint_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, uint_kind, assign_error_nocheck> {
    };

    // Floating point -> signed int with overflow checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, real_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, real_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, real_kind, assign_error_fractional>
        : base_kernel<assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, real_kind, assign_error_fractional>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, real_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, real_kind, assign_error_fractional> {
    };

    // Complex floating point -> signed int with overflow checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, complex_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, complex_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, complex_kind, assign_error_fractional>
        : base_kernel<assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, complex_kind, assign_error_fractional>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, complex_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, complex_kind, assign_error_fractional> {
    };

    // Floating point -> unsigned int with overflow checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, real_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, real_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, real_kind, assign_error_fractional>
        : base_kernel<assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, real_kind, assign_error_fractional>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, real_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, real_kind, assign_error_fractional> {
    };

    // Complex floating point -> unsigned int with overflow checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, complex_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, complex_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, complex_kind, assign_error_fractional>
        : base_kernel<assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, complex_kind, assign_error_fractional>,
                      1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, complex_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, complex_kind, assign_error_fractional> {
    };

    // float -> float with no checking
    template <>
    struct assignment_kernel<float32_id, float_kind_id, float32_id, real_kind, assign_error_overflow>
        : assignment_kernel<float32_id, float_kind_id, float32_id, real_kind, assign_error_nocheck> {
    };

    template <>
    struct assignment_kernel<float32_id, float_kind_id, float32_id, real_kind, assign_error_fractional>
        : assignment_kernel<float32_id, float_kind_id, float32_id, real_kind, assign_error_nocheck> {
    };

    template <>
    struct assignment_kernel<float32_id, float_kind_id, float32_id, real_kind, assign_error_inexact>
        : assignment_kernel<float32_id, float_kind_id, float32_id, real_kind, assign_error_nocheck> {
    };

    // complex<float> -> complex<float> with no checking
    template <>
    struct assignment_kernel<complex_float32_id, complex_kind_id, complex_float32_id, complex_kind,
                             assign_error_overflow>
        : assignment_kernel<complex_float32_id, complex_kind_id, complex_float32_id, complex_kind,
    ...
    template <>
    struct assignment_kernel<float64_id, float_kind_id, float32_id, real_kind, assign_error_overflow>
        : assignment_kernel<float64_id, float_kind_id, float32_id, real_kind, assign_error_nocheck> {
    };

    template <>
    struct assignment_kernel<float64_id, float_kind_id, float32_id, real_kind, assign_error_fractional>
        : assignment_kernel<float64_id, float_kind_id, float32_id, real_kind, assign_error_nocheck> {
    };

    template <>
    struct assignment_kernel<float64_id, float_kind_id, float32_id, real_kind, assign_error_inexact>
        : assignment_kernel<float64_id, float_kind_id, float32_id, real_kind, assign_error_nocheck> {
    };

    // complex<float> -> complex<double> with no checking
    template <>
    struct assignment_kernel<complex_float64_id, complex_kind_id, complex_float32_id, complex_kind,
                             assign_error_overflow>
        : assignment_kernel<complex_float64_id, complex_kind_id, complex_float32_id, complex_kind,
                            assign_error_nocheck> {
    };
    ...
    template <>
    struct assignment_kernel<float64_id, float_kind_id, float64_id, real_kind, assign_error_overflow>
        : assignment_kernel<float64_id, float_kind_id, float64_id, real_kind, assign_error_nocheck> {
    };

    template <>
    struct assignment_kernel<float64_id, float_kind_id, float64_id, real_kind, assign_error_fractional>
        : assignment_kernel<float64_id, float_kind_id, float64_id, real_kind, assign_error_nocheck> {
    };

    template <>
    struct assignment_kernel<float64_id, float_kind_id, float64_id, real_kind, assign_error_inexact>
        : assignment_kernel<float64_id, float_kind_id, float64_id, real_kind, assign_error_nocheck> {
    };

    // complex<double> -> complex<double> with no checking
    template <>
    struct assignment_kernel<complex_float64_id, complex_kind_id, complex_float64_id, complex_kind,
                             assign_error_overflow>
        : assignment_kernel<complex_float64_id, complex_kind_id, complex_float64_id, complex_kind,
                            assign_error_nocheck> {
    };
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, real_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, real_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, real_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, real_kind, assign_error_overflow> {
    };

    // real -> real with inexact checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, real_kind, assign_error_inexact>
        : base_kernel<assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, real_kind, assign_error_inexact>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t Src0TypeID, type_kind_t Src0TypeKind>
    struct assignment_kernel<bool_id, bool_kind_id, Src0TypeID, Src0TypeKind, assign_error_overflow>
        : base_kernel<assignment_kernel<bool_id, bool_kind_id, Src0TypeID, Src0TypeKind, assign_error_overflow>, 1> {
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t Src0TypeID, type_kind_t Src0TypeKind>
    struct assignment_kernel<bool_id, bool_kind_id, Src0TypeID, Src0TypeKind, assign_error_fractional>
        : assignment_kernel<bool_id, bool_kind_id, Src0TypeID, Src0TypeKind, assign_error_overflow> {
    };

    template <type_id_t Src0TypeID, type_kind_t Src0TypeKind>
    struct assignment_kernel<bool_id, bool_kind_id, Src0TypeID, Src0TypeKind, assign_error_inexact>
        : assignment_kernel<bool_id, bool_kind_id, Src0TypeID, Src0TypeKind, assign_error_overflow> {
    };

    // Boolean -> boolean with other error checking
    template <>
    struct assignment_kernel<bool_id, bool_kind_id, bool_id, bool_kind, assign_error_overflow>
        : assignment_kernel<bool_id, bool_kind_id, bool_id, bool_kind, assign_error_nocheck> {
    };

    template <>
    struct assignment_kernel<bool_id, bool_kind_id, bool_id, bool_kind, assign_error_fractional>
        : assignment_kernel<bool_id, bool_kind_id, bool_id, bool_kind, assign_error_nocheck> {
    };

    template <>
    struct assignment_kernel<bool_id, bool_kind_id, bool_id, bool_kind, assign_error_inexact>
        : assignment_kernel<bool_id, bool_kind_id, bool_id, bool_kind, assign_error_nocheck> {
    };

    // Boolean -> anything with other error checking
    template <type_id_t DstTypeID, type_id_t DstBaseID>
    struct assignment_kernel<DstTypeID, DstBaseID, bool_id, bool_kind, assign_error_overflow>
        : assignment_kernel<DstTypeID, DstBaseID, bool_id, bool_kind, assign_error_nocheck> {
    };

    template <type_id_t DstTypeID, type_id_t DstBaseID>
    struct assignment_kernel<DstTypeID, DstBaseID, bool_id, bool_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, DstBaseID, bool_id, bool_kind, assign_error_nocheck> {
    };

    template <type_id_t DstTypeID, type_id_t DstBaseID>
    struct assignment_kernel<DstTypeID, DstBaseID, bool_id, bool_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, DstBaseID, bool_id, bool_kind, assign_error_nocheck> {
    };

    // Signed int -> signed int with overflow checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, sint_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, sint_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, sint_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, sint_kind, assign_error_overflow> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, sint_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, sint_kind, assign_error_overflow> {
    };
    ...
    // sizeof(src)
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, uint_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, uint_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, uint_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, uint_kind, assign_error_overflow> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, uint_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, int_kind_id, Src0TypeID, uint_kind, assign_error_overflow> {
    };
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, sint_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, sint_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, sint_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, sint_kind, assign_error_overflow> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, sint_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, sint_kind, assign_error_overflow> {
    };
    ...
    // sizeof(src)
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, uint_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, uint_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, uint_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, uint_kind, assign_error_overflow> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, uint_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, uint_kind_id, Src0TypeID, uint_kind, assign_error_overflow> {
    };

    // Signed int -> floating point with inexact checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, sint_kind, assign_error_inexact>
        : base_kernel<assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, sint_kind, assign_error_inexact>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, sint_kind, assign_error_overflow>
        : assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, sint_kind, assign_error_nocheck> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, sint_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, sint_kind, assign_error_nocheck> {
    };

    template <type_id_t DstTypeID, type_id_t Src0TypeID, assign_error_mode ErrorMode>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, real_kind, ErrorMode>
        : base_kernel<assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, real_kind, ErrorMode>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, complex_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, complex_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, complex_kind, assign_error_inexact>
        : assignment_kernel<DstTypeID, float_kind_id, Src0TypeID, complex_kind, assign_error_overflow> {
    };

    // complex -> real with fractional checking
    template <type_id_t DstTypeID, type_id_t SrcTypeID>
    struct assignment_kernel<DstTypeID, float_kind_id, SrcTypeID, complex_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, float_kind_id, SrcTypeID, complex_kind, assign_error_overflow> {
    };

    // complex<double> -> float with inexact checking
    template <>
    struct assignment_kernel<float32_id, float_kind_id, complex_float64_id, complex_kind, assign_error_inexact>
        : base_kernel<
              assignment_kernel<float32_id, float_kind_id, complex_float64_id, complex_kind, assign_error_inexact>, 1> {
      void single(char *dst, char *const *src)
      {
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, real_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, real_kind, assign_error_overflow>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, real_kind, assign_error_fractional>
        : assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, real_kind, assign_error_overflow> {
    };

    // real -> complex with inexact checking
    template <type_id_t DstTypeID, type_id_t Src0TypeID>
    struct assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, real_kind, assign_error_inexact>
        : base_kernel<assignment_kernel<DstTypeID, complex_kind_id, Src0TypeID, real_kind, assign_error_inexact>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
      typedef typename type_of<Src0TypeID>::type src0_type;
    ...
    template <>
    struct assignment_kernel<complex_float32_id, complex_kind_id, complex_float64_id, complex_kind,
                             assign_error_overflow>
        : base_kernel<assignment_kernel<complex_float32_id, complex_kind_id, complex_float64_id, complex_kind,
                                        assign_error_overflow>,
                      1> {
    ...
    struct assignment_kernel<complex_float32_id, complex_kind_id, complex_float64_id, complex_kind,
                             assign_error_fractional>
        : assignment_kernel<complex_float32_id, complex_kind_id, complex_float64_id, complex_kind,
                            assign_error_overflow> {
    };
    ...
    struct assignment_kernel<option_id, any_kind_id, option_id, option_kind, ErrorMode>
        : base_kernel<assignment_kernel<option_id, any_kind_id, option_id, option_kind, ErrorMode>, 1> {
    ...
    struct assignment_kernel<option_id, any_kind_id, Src0TypeID, real_kind, ErrorMode> {
      static void instantiate(char *DYND_UNUSED(static_data), char *DYND_UNUSED(data), kernel_builder *ckb,
                              const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t nsrc, const ndt::type *src_tp,
                              const char *const *src_arrmeta, kernel_request_t kernreq, intptr_t nkwd,
                              const nd::array *kwds, const std::map<std::string, ndt::type> &tp_vars)
      {
        ...
        assignment_kernel<option_id, any_kind_id, option_id, option_kind, ErrorMode>::instantiate(
            NULL, NULL, ckb, dst_tp, dst_arrmeta, nsrc, &src_tp_as_option, src_arrmeta, kernreq, nkwd, kwds, tp_vars);
      }
    };

    template <assign_error_mode ErrorMode>
    struct assignment_kernel<option_id, any_kind_id, string_id, string_kind, ErrorMode> {
      static void instantiate(char *DYND_UNUSED(static_data), char *DYND_UNUSED(data), kernel_builder *ckb,
                              const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t nsrc, const ndt::type *src_tp,
                              const char *const *src_arrmeta, kernel_request_t kernreq, intptr_t nkwd,
                              const nd::array *kwds, const std::map<std::string, ndt::type> &tp_vars)
  ...
  namespace detail {
    ...
    template <>
    struct assignment_virtual_kernel<fixed_bytes_id, bytes_kind_id, fixed_bytes_id, bytes_kind>
        : base_kernel<assignment_virtual_kernel<fixed_bytes_id, bytes_kind_id, fixed_bytes_id, bytes_kind>> {
      size_t data_size;
    ...
    template <type_id_t Src0TypeID, assign_error_mode ErrorMode>
    struct assignment_kernel<string_id, string_kind_id, Src0TypeID, sint_kind, ErrorMode>
        : base_kernel<assignment_kernel<string_id, string_kind_id, Src0TypeID, sint_kind, ErrorMode>, 1> {
    ...
    struct assignment_kernel<fixed_string_id, string_kind_id, Src0TypeID, Src0TypeKind, ErrorMode>
        : assignment_kernel<string_id, string_kind_id, int32_id, sint_kind, ErrorMode> {
    };

    template <>
    struct assignment_virtual_kernel<tuple_id, scalar_kind_id, tuple_id, tuple_kind>
        : base_kernel<assignment_virtual_kernel<tuple_id, scalar_kind_id, tuple_id, tuple_kind>> {
      static void instantiate(char *DYND_UNUSED(static_data), char *DYND_UNUSED(data), kernel_builder *ckb,
                              const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t DYND_UNUSED(nsrc),
    ...
    template <>
    struct assignment_virtual_kernel<struct_id, tuple_id, struct_id, struct_kind>
        : base_kernel<assignment_virtual_kernel<struct_id, tuple_id, struct_id, struct_kind>> {
      static void instantiate(char *DYND_UNUSED(static_data), char *DYND_UNUSED(data), kernel_builder *ckb,
                              const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t DYND_UNUSED(nsrc),
                              const ndt::type *src_tp, const char *const *src_arrmeta, kernel_request_t kernreq,
                              intptr_t DYND_UNUSED(nkwd), const nd::array *DYND_UNUSED(kwds),
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<string_id, string_kind_id, fixed_string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<string_id, string_kind_id, fixed_string_id, string_kind, ErrorMode>, 1> {
    ...
    template <>
    struct assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_nocheck>
        : base_kernel<assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_nocheck>, 1> {
    ...
    template <>
    struct assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_inexact>
        : base_kernel<assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_inexact>, 1> {
      ndt::type src_string_tp;
      const char *src_arrmeta;
    ...
    template <>
    struct assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_default>
        : base_kernel<assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_default>, 1> {
      ndt::type src_string_tp;
      const char *src_arrmeta;
    ...
    template <>
    struct assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_overflow>
        : base_kernel<assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_overflow>, 1> {
      ndt::type src_string_tp;
      const char *src_arrmeta;
    ...
    template <>
    struct assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_fractional>
        : base_kernel<assignment_kernel<bool_id, bool_kind_id, string_id, string_kind, assign_error_fractional>, 1> {
      ndt::type src_string_tp;
      const char *src_arrmeta;
    ...
    template <type_id_t Src0TypeID, assign_error_mode ErrorMode>
    struct assignment_kernel<Src0TypeID, int_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<Src0TypeID, int_kind_id, string_id, string_kind, ErrorMode>, 1> {
    ...
    struct assignment_virtual_kernel<DstTypeID, uint_kind_id, string_id, string_kind>
        : base_kernel<assignment_virtual_kernel<DstTypeID, uint_kind_id, string_id, string_kind>, 1> {
      typedef typename type_of<DstTypeID>::type dst_type;
    ...
    template <type_id_t DstTypeID>
    struct assignment_virtual_kernel<DstTypeID, uint_kind_id, string_id, string_kind, assign_error_nocheck>
        : base_kernel<assignment_virtual_kernel<DstTypeID, uint_kind_id, string_id, string_kind, assign_error_nocheck>,
                      1> {
      typedef typename type_of<DstTypeID>::type dst_type;
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<float16_id, float_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<float16_id, float_kind_id, string_id, string_kind, ErrorMode>, 1> {
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<float32_id, float_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<float32_id, float_kind_id, string_id, string_kind, ErrorMode>, 1> {
      ndt::type src_string_tp;
      const char *src_arrmeta;
      ...
      void single(char *dst, char *const *src)
      {
        ...
        dynd::nd::detail::assignment_kernel<float32_id, float_kind_id, float64_id, real_kind,
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<float64_id, float_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<float64_id, float_kind_id, string_id, string_kind, ErrorMode>, 1> {
      ndt::type src_string_tp;
      const char *src_arrmeta;
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<float128_id, float_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<float128_id, float_kind_id, string_id, string_kind, ErrorMode>, 1> {
      void single(char *DYND_UNUSED(dst), char *const *DYND_UNUSED(src))
      {
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<complex_float32_id, complex_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<complex_float32_id, complex_kind_id, string_id, string_kind, ErrorMode>, 1> {
      void single(char *DYND_UNUSED(dst), char *const *DYND_UNUSED(src))
      {
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<complex_float64_id, complex_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<complex_float64_id, complex_kind_id, string_id, string_kind, ErrorMode>, 1> {
      void single(char *DYND_UNUSED(dst), char *const *DYND_UNUSED(src))
      {
    ...
    struct assignment_kernel<DstTypeID, int_kind_id, fixed_string_id, string_kind, ErrorMode>
        : assignment_kernel<DstTypeID, int_kind_id, string_id, string_kind, ErrorMode> {
    };

    template <assign_error_mode ErrorMode>
    struct assignment_kernel<fixed_string_id, string_kind_id, fixed_string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<fixed_string_id, string_kind_id, fixed_string_id, string_kind, ErrorMode>, 1> {
      next_unicode_codepoint_t m_next_fn;
      append_unicode_codepoint_t m_append_fn;
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<char_id, string_kind_id, char_id, char_kind, ErrorMode>
        : assignment_kernel<fixed_string_id, string_kind_id, fixed_string_id, string_kind, ErrorMode> {
    };

    template <assign_error_mode ErrorMode>
    struct assignment_kernel<char_id, string_kind_id, fixed_string_id, string_kind, ErrorMode>
        : assignment_kernel<fixed_string_id, string_kind_id, fixed_string_id, string_kind, ErrorMode> {
    };
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<fixed_string_id, string_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<fixed_string_id, string_kind_id, string_id, string_kind, ErrorMode>, 1> {
      next_unicode_codepoint_t m_next_fn;
      append_unicode_codepoint_t m_append_fn;
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<char_id, string_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<char_id, string_kind_id, string_id, string_kind, ErrorMode>> {
      static void instantiate(char *DYND_UNUSED(static_data), char *DYND_UNUSED(data), kernel_builder *ckb,
                              const ndt::type &dst_tp, const char *DYND_UNUSED(dst_arrmeta), intptr_t DYND_UNUSED(nsrc),
                              const ndt::type *src_tp, const char *const *DYND_UNUSED(src_arrmeta),
                              kernel_request_t kernreq, intptr_t DYND_UNUSED(nkwd), const nd::array *DYND_UNUSED(kwds),
      ...
      {
        const ndt::base_string_type *src_fs = src_tp[0].extended<ndt::base_string_type>();
        ckb->emplace_back<assignment_kernel<fixed_string_id, string_kind_id, string_id, string_kind, ErrorMode>>(
            kernreq, get_next_unicode_codepoint_function(src_fs->get_encoding(), ErrorMode),
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<fixed_string_id, string_kind_id, char_id, char_kind, ErrorMode>
        : assignment_kernel<fixed_string_id, string_kind_id, fixed_string_id, string_kind, ErrorMode> {
    };

    template <assign_error_mode ErrorMode>
    struct assignment_kernel<string_id, string_kind_id, char_id, char_kind, ErrorMode>
        : base_kernel<assignment_kernel<string_id, string_kind_id, char_id, char_kind, ErrorMode>> {
      static void instantiate(char *DYND_UNUSED(static_data), char *DYND_UNUSED(data), kernel_builder *ckb,
                              const ndt::type &dst_tp, const char *DYND_UNUSED(dst_arrmeta), intptr_t DYND_UNUSED(nsrc),
                              const ndt::type *src_tp, const char *const *DYND_UNUSED(src_arrmeta),
                              kernel_request_t kernreq, intptr_t DYND_UNUSED(nkwd), const nd::array *DYND_UNUSED(kwds),
                              const std::map<std::string, ndt::type> &DYND_UNUSED(tp_vars))
      {
        ckb->emplace_back<assignment_kernel<string_id, string_kind_id, fixed_string_id, string_kind, ErrorMode>>(
            kernreq, dst_tp.extended<ndt::base_string_type>()->get_encoding(),
    ...
    template <>
    struct assignment_virtual_kernel<pointer_id, any_kind_id, pointer_id, expr_kind>
        : base_kernel<assignment_virtual_kernel<pointer_id, any_kind_id, pointer_id, expr_kind>, 1> {
    ...
    template <>
    struct assignment_virtual_kernel<type_id, any_kind_id, type_id, type_kind>
        : base_kernel<assignment_virtual_kernel<type_id, any_kind_id, type_id, type_kind>, 1> {
      void single(char *dst, char *const *src)
      {
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<type_id, any_kind_id, string_id, string_kind, ErrorMode>
        : base_kernel<assignment_kernel<type_id, any_kind_id, string_id, string_kind, ErrorMode>, 1> {
    ...
    template <assign_error_mode ErrorMode>
    struct assignment_kernel<string_id, string_kind_id, type_id, type_kind, ErrorMode>
        : base_kernel<assignment_kernel<string_id, string_kind_id, type_id, type_kind, ErrorMode>, 1> {
