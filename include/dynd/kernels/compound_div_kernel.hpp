...
namespace nd {
  ...
  struct compound_div_kernel<
      DstType, Src0Type,
      false> : base_kernel<compound_div_kernel<DstType, Src0Type, false>,
  ...
  struct compound_div_kernel<
      DstType, Src0Type,
      true> : base_kernel<compound_div_kernel<DstType, Src0Type, true>,
                          kernel_request_host, 1> {
    typedef DstType dst_type;
    typedef Src0Type src0_type;
  ...
  struct compound_div_kernel<
      bool1, Src0Type,
      true> : base_kernel<compound_div_kernel<bool1, Src0Type, true>,
                          kernel_request_host, 1> {
