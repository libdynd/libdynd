...
struct single_assigner_builtin_base<dst_type, complex<src_real_type>, sint_kind,
                                    complex_kind, assign_error_nocheck> {
  DYND_CUDA_HOST_DEVICE static void assign(dst_type *dst,
                                           const complex<src_real_type> *src)
  {
    DYND_TRACE_ASSIGNMENT(static_cast<dst_type>(src->real()), dst_type, *src,
...
struct single_assigner_builtin_base<float, complex<src_real_type>, real_kind,
                                    complex_kind, assign_error_nocheck> {
  DYND_CUDA_HOST_DEVICE static void assign(float *dst,
                                           const complex<src_real_type> *src)
  {
    DYND_TRACE_ASSIGNMENT(static_cast<float>(src->real()), dst_type, *src,
                          complex<src_real_type>);
...
template <class src_real_type>
struct single_assigner_builtin_base<double, complex<src_real_type>, real_kind,
                                    complex_kind, assign_error_nocheck> {
  DYND_CUDA_HOST_DEVICE static void assign(double *dst,
                                           const complex<src_real_type> *src)
  {
    DYND_TRACE_ASSIGNMENT(static_cast<double>(src->real()), dst_type, *src,
                          complex<src_real_type>);
...
struct single_assigner_builtin_base<complex<dst_real_type>, src_type,
                                    ...
                                    assign_error_nocheck> {
  DYND_CUDA_HOST_DEVICE static void assign(complex<dst_real_type> *dst,
                                           const src_type *src)
  {
...
template <class dst_type, class src_type>
struct single_assigner_builtin_base<dst_type, src_type, real_kind, uint_kind,
                                    assign_error_inexact> {
  static void assign(dst_type *dst, const src_type *src)
  {
    src_type s = *src;
