...
{
    static void assign(dynd_complex<dst_real_type> *dst, const src_type *src) {
        src_type s = *src;
...
{
    static void assign(dst_type *dst, const dynd_complex<src_real_type> *src) {
...
{
    static void assign(dynd_complex<float> *dst, const dynd_complex<double> *src) {
...
{
    static void assign(real_type *dst, const dynd_complex<real_type> *src) {
...
{
    static void assign(double *dst, const dynd_complex<float> *src) {
...
{
    static void assign(float *dst, const dynd_complex<double> *src) {
        dynd_complex<double> s = *src;
        float d;
...
{
    static void assign(dynd_complex<float> *dst, const double *src) {
        double s = *src;
        float d;
