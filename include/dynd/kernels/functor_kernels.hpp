...
struct functor_ck<func_type, R (A...), naux, construct> : kernels::apply_callable_ck<func_type, R,
  type_sequence<A...>, make_index_sequence<sizeof...(A)>, type_sequence<>, make_index_sequence<0> > {
};
