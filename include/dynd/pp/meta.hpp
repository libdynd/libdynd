...
#define DYND_PP_META_VAR_RANGE(VAR, STOP) DYND_PP_OUTER(DYND_PP_PASTE, (VAR), DYND_PP_RANGE(STOP))

#define DYND_PP_META_VAR_AT_RANGE(VAR, STOP) DYND_PP_OUTER(DYND_PP_META_AT, (VAR), DYND_PP_RANGE(STOP))
