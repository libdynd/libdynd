...
// #define DYND_PP_META_NAME_RANGE(NAME, ...) DYND_PP_MAP_1(DYND_PP_PASTE, (NAME), DYND_PP_RANGE(__VA_ARGS__))


#define DYND_PP_META_NAME_RANGE(NAME, ...) DYND_PP_META__NAME_RANGE(NAME, DYND_PP_RANGE(__VA_ARGS__))
#define DYND_PP_META__NAME_RANGE(NAME, LIST) DYND_PP_ELWISE_1(DYND_PP_PASTE, DYND_PP_REPEAT_1(NAME, DYND_PP_LEN(LIST)), LIST)
