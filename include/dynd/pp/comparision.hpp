...
#define DYND_PP_LT(A, B) DYND_PP_CAT_4(DYND_PP_LT_, DYND_PP_BOOL(A), \
    _, DYND_PP_BOOL(B))(DYND_PP_GET(A, (DYND_PP_ID DYND_PP_SLICE_TO(B, DYND_PP_CAT_2(DYND_PP_ONES_, \
    DYND_PP_LEN_MAX)), DYND_PP_ID DYND_PP_CAT_2(DYND_PP_ZEROS_, DYND_PP_LEN_MAX))))
...
#define DYND_PP_GE(A, B) DYND_PP_CAT_4(DYND_PP_GE_, DYND_PP_BOOL(A), \
    _, DYND_PP_BOOL(B))(DYND_PP_GET(A, (DYND_PP_ID DYND_PP_SLICE_TO(B, DYND_PP_CAT_2(DYND_PP_ZEROS_, DYND_PP_LEN_MAX)), \
    DYND_PP_ID DYND_PP_CAT_2(DYND_PP_ONES_, DYND_PP_LEN_MAX))))
