...
class TestDType(unittest.TestCase):
    ...
    def test_bool_dtype_properties(self):
        ...
        self.assertEqual(nd.bool.itemsize, 1)
    ...
    def test_complex_dtype_properties(self):
        ...
        self.assertEqual(nd.cfloat32.itemsize, 8)
        ...
        self.assertEqual(nd.cfloat64.itemsize, 16)
