...
TEST(ArrayLinspace, Basic) {
  ...
  a = nd::old_linspace(dynd::complex<float>(0.f, 0.f), dynd::complex<float>(0.f, 1.f), 3);
  ...
  a = nd::old_linspace(dynd::complex<double>(1.f, 0.f), dynd::complex<double>(0.f, 1.f), 3);
