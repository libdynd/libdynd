...
public:
  ...
  static inline bool IsTypeID(type_id_t DYND_UNUSED(type_id)) { return false; }

  static inline ndt::type MakeType(const ndt::type &target_tp) { return target_tp; }
...
public:
  ...
  static inline bool IsTypeID(type_id_t type_id) { return TypeID == type_id; }
...
public:
  ...
  static inline ndt::type MakeType(const ndt::type &target_tp) { return make_cuda_device(target_tp); }
  ...
  static inline nd::array To(const nd::array &a) { return a.to_cuda_device(); }
};

typedef ::testing::Types<cuda_host_type, cuda_device_type> CUDAMemory;
typedef ::testing::Types<
    ::testing::Types2<None, cuda_host_type>, ::testing::Types2<None, cuda_device_type>,
    ...
    ::testing::Types2<cuda_device_type, cuda_host_type>, ::testing::Types2<cuda_device_type, cuda_device_type>>
    CUDAMemoryPairs;
