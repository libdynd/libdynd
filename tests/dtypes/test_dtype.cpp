...
TEST(DType, BasicConstructor) {
    ...
    // unsigned long
    d = ndt::make_dtype<unsigned long>();
    EXPECT_EQ(uint_kind, d.get_kind());
    ...
    // unsigned long long
    d = ndt::make_dtype<unsigned long long>();
