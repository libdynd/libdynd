...
TEST(ByteswapDType, Basic) {
    ...
    a = make_scalar_ndobject(make_byteswap_dtype<int16_t>(), (char *)&value16);
    EXPECT_EQ(0x6213, a.as<int16_t>());

    int32_t value32 = 0x12345678;
    a = make_scalar_ndobject(make_byteswap_dtype<int32_t>(), (char *)&value32);
    EXPECT_EQ(0x78563412, a.as<int32_t>());

    int64_t value64 = 0x12345678abcdef01LL;
    a = make_scalar_ndobject(make_byteswap_dtype<int64_t>(), (char *)&value64);
    EXPECT_EQ(0x01efcdab78563412LL, a.as<int64_t>());

    value32 = 0xDA0F4940;
    a = make_scalar_ndobject(make_byteswap_dtype<float>(), (char *)&value32);
    ...
    a = make_scalar_ndobject(make_byteswap_dtype<complex<float> >(), (char *)&value32_pair);
    ...
    a = make_scalar_ndobject(make_byteswap_dtype<complex<double> >(), (char *)&value64_pair);
