...
TEST(FixedstringDType, Basic) {
    ...
    EXPECT_EQ(ndt::make_convert(ndt::make_fixed_string(7, string_encoding_utf_16),
                ...
                a.get_type());
    a = a.eval();
    EXPECT_EQ(ndt::make_fixed_string(7, string_encoding_utf_16),
                    a.get_type());
    //cout << a << endl;
}
...
TEST(FixedstringDType, CanonicalDType) {
    EXPECT_EQ((ndt::make_fixed_string(12, string_encoding_ascii)),
                (ndt::make_fixed_string(12, string_encoding_ascii).get_canonical_type()));
    EXPECT_EQ((ndt::make_fixed_string(14, string_encoding_utf_8)),
    ...
    EXPECT_EQ((ndt::make_fixed_string(17, string_encoding_utf_16)),
                (ndt::make_fixed_string(17, string_encoding_utf_16).get_canonical_type()));
    EXPECT_EQ((ndt::make_fixed_string(21, string_encoding_utf_32)),
                (ndt::make_fixed_string(21, string_encoding_utf_32).get_canonical_type()));
}
