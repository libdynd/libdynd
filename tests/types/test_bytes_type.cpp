...
TEST(BytesDType, Create)
{
  ...
  EXPECT_EQ(1u, d.p("target_alignment").size);
  ...
  EXPECT_EQ(2u, d.p("target_alignment").size);
  // Roundtripping through a string
  EXPECT_EQ(d, ndt::type(d.str()));
  ...
  EXPECT_EQ(4u, d.p("target_alignment").size);
  // Roundtripping through a string
  EXPECT_EQ(d, ndt::type(d.str()));
  ...
  EXPECT_EQ(8u, d.p("target_alignment").size);
  // Roundtripping through a string
  EXPECT_EQ(d, ndt::type(d.str()));
  ...
  EXPECT_EQ(16u, d.p("target_alignment").size);
  // Roundtripping through a string
  EXPECT_EQ(d, ndt::type(d.str()));
}
