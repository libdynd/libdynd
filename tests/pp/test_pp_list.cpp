...
TEST(PPList, SliceWith) {
    ...
    EXPECT_TRUE(DYND_PP_ALL_EQ((DYND_PP_SLICE_WITH(4, 2, 1, 4, 7, 3)), (2)));
    ...
    EXPECT_TRUE(DYND_PP_ALL_EQ((DYND_PP_SLICE_WITH(5, 5, 1, 4, 3, 7, 0, 2, 6)), (5)));
    EXPECT_TRUE(DYND_PP_ALL_EQ((DYND_PP_SLICE_WITH(6, 5, 1, 4, 3, 7, 0, 2, 6)), (5)));
    EXPECT_TRUE(DYND_PP_ALL_EQ((DYND_PP_SLICE_WITH(7, 5, 1, 4, 3, 7, 0, 2, 6)), (5)));
    EXPECT_TRUE(DYND_PP_ALL_EQ((DYND_PP_SLICE_WITH(DYND_PP_INT_MAX, 5, 1, 4, 3, 7, 0, 2, 6)), (5)));
}
...
TEST(PPList, Reduce) {
    ...
    EXPECT_TRUE(DYND_PP_REDUCE(DYND_PP_AND, 5, 1, 4, 3, 7, 1, 2, 6));
...
TEST(PPList, All) {
    ...
    EXPECT_TRUE(DYND_PP_ALL(1, DYND_PP_RANGE(1, DYND_PP_LEN_MAX)));
}
...
TEST(PPList, Any) {
    ...
    EXPECT_TRUE(DYND_PP_ANY(1, DYND_PP_RANGE(1, DYND_PP_LEN_MAX)));
}
