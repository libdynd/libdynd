...
TEST(PPList, Range) {
    ...
    EXPECT_EQ(DYND_PP_LEN(DYND_PP_RANGE(DYND_PP_INT_MAX)), DYND_PP_INT_MAX);
}
...
//    EXPECT_EQ(DYND_PP_GET(DYND_PP_INT_MAX, DYND_PP_RANGE(DYND_PP_INT_MAX)), DYND_PP_INT_MAX - 1);
}
...
//    EXPECT_EQ(DYND_PP_FIRST(DYND_PP_RANGE(DYND_PP_INT_MAX)), 0);
}
