...
TEST(Neighborhood, Sum1D) {
    nd::arrfunc af = make_neighborhood_arrfunc(nd::functional::apply(&sum<1>), 1);
    nd::array a;
...
TEST(Neighborhood, Sum2D) {
    nd::arrfunc af = make_neighborhood_arrfunc(nd::functional::apply(&sum<2>), 2);
    nd::array a;
...
TEST(Neighborhood, Sum3D) {
    nd::arrfunc af = make_neighborhood_arrfunc(nd::functional::apply(&sum<3>), 3);
    nd::array a;
