...
// EXPECT_EQ(53.15, af(3.75, 19).as<double>());
  ...
  /*
    af = nd::apply::make<decltype(&func5), &func5>();
    EXPECT_EQ(1251L, af(nd::array({{1242L, 23L, -5L}, {925L, -836L,
    -14L}}).view(ndt::make_type<long[2][3]>())).as<long>());
    af = nd::apply::make(&func5);
    EXPECT_EQ(1251L, af(nd::array({{1242L, 23L, -5L}, {925L, -836L,
    -14L}}).view(ndt::make_type<long[2][3]>())).as<long>());
  */

  af = nd::apply::make<decltype(&func6), &func6>();
  EXPECT_EQ(8, af(3, 5, 7).as<int>());
  af = nd::apply::make(&func6);
  EXPECT_EQ(8, af(3, 5, 7).as<int>());

  af = nd::apply::make<decltype(&func7), &func7>();
  EXPECT_EQ(36.3, af(38, 5, 12.1).as<double>());
  af = nd::apply::make(&func7);
  EXPECT_EQ(36.3, af(38, 5, 12.1).as<double>());
}
...
*/
  ...
  af = nd::apply::make(&func6, "z");
  EXPECT_EQ(8, af(3, 5, kwds("z", 7)).as<int>());

  af = nd::apply::make<decltype(&func6), &func6>("y", "z");
  EXPECT_EQ(8, af(3, kwds("y", 5, "z", 7)).as<int>());
  af = nd::apply::make(&func6, "y", "z");
  EXPECT_EQ(8, af(3, kwds("y", 5, "z", 7)).as<int>());

  af = nd::apply::make<decltype(&func6), &func6>("x", "y", "z");
  EXPECT_EQ(8, af(kwds("x", 3, "y", 5, "z", 7)).as<int>());
  af = nd::apply::make(&func6, "x", "y", "z");
  EXPECT_EQ(8, af(kwds("x", 3, "y", 5, "z", 7)).as<int>());

  af = nd::apply::make<decltype(&func7), &func7>("z");
  EXPECT_EQ(36.3, af(38, 5, kwds("z", 12.1)).as<double>());
  af = nd::apply::make(&func7, "z");
  EXPECT_EQ(36.3, af(38, 5, kwds("z", 12.1)).as<double>());

  af = nd::apply::make<decltype(&func7), &func7>("y", "z");
  EXPECT_EQ(36.3, af(38, kwds("y", 5, "z", 12.1)).as<double>());
  af = nd::apply::make(&func7, "y", "z");
  EXPECT_EQ(36.3, af(38, kwds("y", 5, "z", 12.1)).as<double>());

  af = nd::apply::make<decltype(&func7), &func7>("x", "y", "z");
  EXPECT_EQ(36.3, af(kwds("x", 38, "y", 5, "z", 12.1)).as<double>());
  af = nd::apply::make(&func7, "x", "y", "z");
  EXPECT_EQ(36.3, af(kwds("x", 38, "y", 5, "z", 12.1)).as<double>());
}
...
TYPED_TEST_P(Apply, Callable)
{
  ...
  if (TestFixture::KernelRequest == kernel_request_host) {
    typedef func_wrapper<kernel_request_host, decltype(&func0), &func0>
        func0_as_callable;
    af = nd::apply::make<kernel_request_host, func0_as_callable>();
    EXPECT_EQ(4, af(TestFixture::To(5), TestFixture::To(3)).template as<int>());
    af = nd::apply::make(func0_as_callable());
    EXPECT_EQ(4, af(5, 3).as<int>());
  }
  ...
  if (TestFixture::KernelRequest == kernel_request_cuda_device) {
    typedef func_wrapper<kernel_request_cuda_device, decltype(&func1), &func1>
        func1_as_callable;
    af =
        nd::apply::make<kernel_request_cuda_device, func1_as_callable>();
...
#endif
  /*
    af = nd::apply::make(func1_as_callable());
    EXPECT_EQ(53.15, af(3.75, 19).as<double>());
  */
  ...
  func2_as_callable;
    af = nd::apply::make<kernel_request_host, func2_as_callable>();
    EXPECT_FLOAT_EQ(13.2f, af(nd::array({3.9f, -7.0f,
  16.3f}).view(ndt::make_type<float[3]>())).as<float>());
    af = nd::apply::make(func2_as_callable());
    EXPECT_FLOAT_EQ(13.2f, af(nd::array({3.9f, -7.0f,
  16.3f}).view(ndt::make_type<float[3]>())).as<float>());
  ...
  func3_as_callable>();
    EXPECT_EQ(12U, af().as<unsigned int>());
  //  af = nd::apply::make(func3_as_callable());
    //EXPECT_EQ(12U, af().as<unsigned int>());
  */

  /*
    af = nd::apply::make<func4_as_callable>();
  ...
  */
  ...
  /*
    af = nd::apply::make<func5_as_callable>();
    EXPECT_EQ(1251L, af(nd::array({{1242L, 23L, -5L}, {925L, -836L,
    -14L}}).view(ndt::make_type<long[2][3]>())).as<long>());
    af = nd::apply::make(func5_as_callable());
    EXPECT_EQ(1251L, af(nd::array({{1242L, 23L, -5L}, {925L, -836L,
  ...
  */
  ...
  af = nd::apply::make<TestFixture::KernelRequest, func6_as_callable>();
  EXPECT_EQ(8, af(TestFixture::To(3), TestFixture::To(5), TestFixture::To(7))
                   .template as<int>());
  //  af = nd::apply::make(func6_as_callable());
  // EXPECT_EQ(8, af(3, 5, 7).as<int>());

  typedef func_wrapper<TestFixture::KernelRequest, decltype(&func7), &func7>
      func7_as_callable;

  af = nd::apply::make<TestFixture::KernelRequest, func7_as_callable>();
  EXPECT_EQ(36.3, af(TestFixture::To(38), TestFixture::To(5),
                     TestFixture::To(12.1)).template as<double>());
  /*

  //  af = nd::apply::make(func7_as_callable());
    //EXPECT_EQ(36.3, af(38, 5, 12.1).as<double>());
  */

  af = nd::apply::make<TestFixture::KernelRequest, callable0>();
...
TYPED_TEST_P(Apply, CallableWithKeywords)
{
  ...
  af = nd::apply::make(func0_as_callable(), "y");
  EXPECT_EQ(4, af(5, kwds("y", 3)).as<int>());

  af = nd::apply::make(func0_as_callable(), "x", "y");
  EXPECT_EQ(4, af(5, kwds("x", 5, "y", 3)).as<int>());
...
/*
  typedef func_wrapper<kernel_request_host, decltype(&func1), &func1>
    ...
    af = nd::apply::make(func1_as_callable(), "y");
    EXPECT_EQ(53.15, af(3.75, kwds("y", 19)).as<double>());

    af = nd::apply::make(func1_as_callable(), "x", "y");
    EXPECT_EQ(53.15, af(kwds("x", 3.75, "y", 19)).as<double>());
*/
  ...
  af = nd::apply::make(func6_as_callable(), "z");
  EXPECT_EQ(8, af(3, 5, kwds("z", 7)).as<int>());

  af = nd::apply::make(func6_as_callable(), "y", "z");
  EXPECT_EQ(8, af(3, kwds("y", 5, "z", 7)).as<int>());

  af = nd::apply::make(func6_as_callable(), "x", "y", "z");
  EXPECT_EQ(8, af(kwds("x", 3, "y", 5, "z", 7)).as<int>());

  typedef func_wrapper<kernel_request_host, decltype(&func7), &func7>
      func7_as_callable;

  af = nd::apply::make(func7_as_callable(), "z");
  EXPECT_EQ(36.3, af(38, 5, kwds("z", 12.1)).as<double>());

  af = nd::apply::make(func7_as_callable(), "y", "z");
  EXPECT_EQ(36.3, af(38, kwds("y", 5, "z", 12.1)).as<double>());

  af = nd::apply::make(func7_as_callable(), "x", "y", "z");
  EXPECT_EQ(36.3, af(kwds("x", 38, "y", 5, "z", 12.1)).as<double>());

  af = nd::apply::make(callable0(), "y");
  EXPECT_EQ(11, af(5, kwds("y", 3)).as<int>());

  af = nd::apply::make(callable0(), "x", "y");
  EXPECT_EQ(11, af(kwds("x", 5, "y", 3)).as<int>());

  af = nd::apply::make(callable0(4), "y");
  EXPECT_EQ(8, af(5, kwds("y", 3)).as<int>());

  af = nd::apply::make(callable0(4), "x", "y");
  EXPECT_EQ(8, af(kwds("x", 5, "y", 3)).as<int>());

  af = nd::apply::make<TestFixture::KernelRequest, callable0, int>("z");
  EXPECT_EQ(8, af(TestFixture::To(5), TestFixture::To(3),
                  kwds("z", TestFixture::To(4))).template as<int>());

  af = nd::apply::make<TestFixture::KernelRequest, callable1, int, int>(
      "x", "y");
