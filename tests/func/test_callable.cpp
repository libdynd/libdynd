...
TEST(GFuncCallable, OneParameter) {
    ...
    EXPECT_EQ(ndt::make_struct(ndt::type::make<int>(), "x"),
...
TEST(GFuncCallable, TwoParameters) {
    ...
    EXPECT_EQ(ndt::make_struct(ndt::type::make<double>(), "a", ndt::type::make<long>(), "b"),
            c.get_parameters_type());
...
TEST(GFuncCallable, ThreeParameters) {
    ...
    EXPECT_EQ(ndt::make_struct(ndt::type::make<bool1>(), "s", ndt::type::make<int>(), "a", ndt::type::make<int>(), "b"),
            c.get_parameters_type());
...
TEST(GFuncCallable, FourParameters) {
    ...
    EXPECT_EQ(ndt::make_struct(ndt::type::make<int8_t>(), "x", ndt::type::make<int16_t>(), "y",
...
TEST(GFuncCallable, FiveParameters) {
    ...
    EXPECT_EQ(ndt::make_struct(ndt::make_fixed_dim(3, ndt::type::make<float>()), "x", ndt::type::make<uint16_t>(), "a1",
...
TEST(GFuncCallable, DTypeParam)
{
  ...
  // With a base_type
  tmp = ndt::make_struct(ndt::type::make<dynd::complex<float>>(), "A",
