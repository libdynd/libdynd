...
TEST(Sum, 1D)
{
  ...
  EXPECT_ARRAY_EQ(-19999999987LL,
                  nd::sum(nd::array{1LL, -20000000000LL, 12LL}));
  ...
  // complex[float32]
  EXPECT_ARRAY_EQ(dynd::complex<float>(1.25f, -2.125f),
  ...
  // complex[float64]
  EXPECT_ARRAY_EQ(dynd::complex<double>(1.25, -2.125),
