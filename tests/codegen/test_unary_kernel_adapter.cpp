...
TEST(UnaryKernelAdapter, BasicOperations) {
    ...
    cgcache.codegen_unary_function_adapter(ndt::make_dtype<int>(), ndt::make_dtype<float>(), cdecl_callconv,
                    (void*)static_cast<int (*)(float)>(&double_value<int, float>), NULL, op_int_float);
    cgcache.codegen_unary_function_adapter(ndt::make_dtype<float>(), ndt::make_dtype<float>(), cdecl_callconv,
                    (void*)static_cast<float (*)(float)>(&double_value<float, float>), NULL, op_float_float);
    cgcache.codegen_unary_function_adapter(ndt::make_dtype<float>(), ndt::make_dtype<double>(), cdecl_callconv,
