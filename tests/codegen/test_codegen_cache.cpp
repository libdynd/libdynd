...
TEST(CodeGenCache, UnaryCaching) {
    ...
    cgcache.codegen_unary_function_adapter(make_dtype<int>(), make_dtype<float>(), cdecl_callconv, &int_float_fn1, op_int_float1);
    cgcache.codegen_unary_function_adapter(make_dtype<int>(), make_dtype<float>(), cdecl_callconv, &int_float_fn2, op_int_float2);
    ...
    cgcache.codegen_unary_function_adapter(make_dtype<unsigned int>(), make_dtype<float>(), cdecl_callconv, &uint_float_fn1, op_uint_float1);
