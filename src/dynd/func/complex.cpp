...
DYND_API nd::callable nd::real::make()
{
  dispatcher<callable> dispatcher =
      callable::new_make_all<real_kernel, type_id_sequence<complex_float32_id, complex_float64_id>>();
...
{
  dispatcher<callable> dispatcher =
      callable::new_make_all<imag_kernel, type_id_sequence<complex_float32_id, complex_float64_id>>();
...
{
  dispatcher<callable> dispatcher =
      callable::new_make_all<conj_kernel, type_id_sequence<complex_float32_id, complex_float64_id>>();
