...
static void delete_lifted_reduction_arrfunc_data(arrfunc_old_type_data *self_af)
{
...
static intptr_t instantiate_lifted_reduction_arrfunc_data(
    const arrfunc_old_type_data *af_self, dynd::ckernel_builder *ckb, intptr_t ckb_offset,
...
void dynd::lift_reduction_arrfunc(arrfunc_old_type_data *out_ar,
                ...
                const nd::array& reduction_identity)
{
    ...
    const arrfunc_old_type_data *elwise_reduction = elwise_reduction_arr.get();
