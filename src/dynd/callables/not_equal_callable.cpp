...
void nd::not_equal_callable<tuple_id, tuple_id>::instantiate(char *DYND_UNUSED(data), kernel_builder *ckb,
                                                             ...
                                                             const std::map<std::string, ndt::type> &tp_vars)
{
  ...
  ckb->emplace_back<not_equal_kernel<tuple_id, tuple_id>>(kernreq, field_count, bsd->get_data_offsets(src_arrmeta[0]),
