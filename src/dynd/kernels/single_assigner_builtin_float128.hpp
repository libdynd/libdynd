...
{
    static void assign(dynd_bool *dst, const dynd_float128 *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(dynd_float128 *dst, const dynd_bool *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
        DYND_TRACE_ASSIGNMENT((bool)(s != src_type(0)), dynd_bool, s, src_type);
