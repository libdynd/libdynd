...
{
  return nd::callable(func_proto, kernel_request_single, kernel_targets_t(), NULL, make_pair(factor, offset), NULL,
                      NULL, &instantiate_int_multiply_and_offset_callable<Tsrc, Tdst>);
}
...
{
  return nd::callable(func_proto, kernel_request_single, kernel_targets_t(), NULL, make_pair(offset, divisor), NULL,
                      NULL, &instantiate_int_offset_and_divide_callable<Tsrc, Tdst>);
}
