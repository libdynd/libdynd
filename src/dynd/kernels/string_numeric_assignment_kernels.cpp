...
static void string_to_bool_single(ckernel_prefix *extra, char *dst,
                                  char *const *src)
{
...
struct overflow_check<int32_t> {
  inline static bool is_overflow(uint64_t value, bool negative)
  {
    return (value & ~0x7fffffffULL) != 0 &&
           !(negative && value == 0x80000000ULL);
  }
};
template <>
...
struct string_to_int {
  static void single(ckernel_prefix *extra, char *dst, char *const *src)
  {
    ...
    if (e->errmode == assign_error_nocheck) {
      uint64_t value =
          parse::unchecked_string_to_uint64(s.data(), s.data() + s.size());
...
static void string_to_int128_single(ckernel_prefix *extra, char *dst,
                                    char *const *src)
{
  string_to_builtin_kernel *e =
      reinterpret_cast<string_to_builtin_kernel *>(extra);
...
static void string_to_uint128_single(ckernel_prefix *extra, char *dst,
                                     char *const *src)
{
  string_to_builtin_kernel *e =
      reinterpret_cast<string_to_builtin_kernel *>(extra);
...
static void string_to_float32_single(ckernel_prefix *extra, char *dst,
                                     char *const *src)
{
  string_to_builtin_kernel *e =
      reinterpret_cast<string_to_builtin_kernel *>(extra);
...
static void string_to_float64_single(ckernel_prefix *extra, char *dst,
                                     char *const *src)
{
  string_to_builtin_kernel *e =
      reinterpret_cast<string_to_builtin_kernel *>(extra);
...
static void string_to_float128_single(ckernel_prefix *DYND_UNUSED(self),
                                      char *DYND_UNUSED(dst),
                                      char *const *DYND_UNUSED(src))
{
  throw std::runtime_error("TODO: implement string_to_float128_single");
}

static void string_to_complex_float32_single(ckernel_prefix *DYND_UNUSED(self),
                                             char *DYND_UNUSED(dst),
                                             char *const *DYND_UNUSED(src))
{
...
static void string_to_complex_float64_single(ckernel_prefix *DYND_UNUSED(self),
                                             char *DYND_UNUSED(dst),
                                             char *const *DYND_UNUSED(src))
{
...
static expr_single_t static_string_to_builtin_kernels
    [builtin_type_id_count - 2] = {
        ...
        &string_to_uint<uint8_t>::single,  &string_to_uint<uint16_t>::single,
        &string_to_uint<uint32_t>::single, &string_to_uint<uint64_t>::single,
        &string_to_uint128_single,         &string_to_float16_single,
        &string_to_float32_single,         &string_to_float64_single,
        &string_to_float128_single,        &string_to_complex_float32_single,
...
struct builtin_to_string_kernel_extra {
  ...
  static void single(ckernel_prefix *extra, char *dst, char *const *src)
  {
    ...
    e->dst_string_tp->set_from_utf8_string(e->dst_arrmeta, dst, ss.str(),
                                           &e->ectx);
  }
                                         ...
                                         const eval::eval_context *ectx)
{
  ...
  make_string_to_builtin_assignment_kernel(&k, 0, dst_type_id, dt,
