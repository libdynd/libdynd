                                     ...
                                     ckernel_prefix *extra)
{
  ...
  case assign_error_nocheck:
    dynd::nd::assignment_kernel<float32_type_id, float64_type_id,
                                assign_error_nocheck>::single_wrapper(dst,
                                                                      child_src,
                                                                      NULL);
    break;
  ...
  case assign_error_inexact:
    dynd::nd::assignment_kernel<float32_type_id, float64_type_id,
                                assign_error_inexact>::single_wrapper(dst,
                                                                      child_src,
                                                                      NULL);
    break;
  default:
...
static void string_to_complex_float32_single(char *DYND_UNUSED(dst),
                                             char *const *DYND_UNUSED(src),
                                             ckernel_prefix *DYND_UNUSED(self))
{
...
static void string_to_complex_float64_single(char *DYND_UNUSED(dst),
                                             char *const *DYND_UNUSED(src),
                                             ckernel_prefix *DYND_UNUSED(self))
{
