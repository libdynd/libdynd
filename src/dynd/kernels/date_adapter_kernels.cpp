  ...
  if (parse_days_since(op.begin(), op.end(), epoch_date)) {
    ...
    case int32_type_id:
      out_forward = make_int_offset_arrfunc<int32_t, int32_t>(
          epoch_date,
          ndt::make_arrfunc(ndt::tuple_type::make(ndt::type::make<int32_t>()),
                            ndt::make_date()));
      out_reverse = make_int_offset_arrfunc<int32_t, int32_t>(
          -epoch_date, ndt::make_arrfunc(ndt::tuple_type::make(ndt::make_date()),
                                         ndt::type::make<int32_t>()));
      return true;
    case int64_type_id:
      out_forward = make_int_offset_arrfunc<int64_t, int32_t>(
          epoch_date,
          ndt::make_arrfunc(ndt::tuple_type::make(ndt::type::make<int64_t>()),
                            ndt::make_date()));
