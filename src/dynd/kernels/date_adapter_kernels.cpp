...
template <class Tsrc, class Tdst>
static intptr_t instantiate_int_offset_callable(char *static_data, char *DYND_UNUSED(data), void *ckb,
...
{
  return nd::callable(func_proto, kernel_request_single, kernel_targets_t(), NULL, offset, NULL, NULL,
