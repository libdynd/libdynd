...
intptr_t nd::masked_take_ck::instantiate(char *DYND_UNUSED(static_data), size_t DYND_UNUSED(data_size),
...
intptr_t nd::indexed_take_ck::instantiate(char *DYND_UNUSED(static_data), size_t DYND_UNUSED(data_size),
                                          char *DYND_UNUSED(data), void *ckb, intptr_t ckb_offset,
                                          const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t DYND_UNUSED(nsrc),
                                          const ndt::type *src_tp, const char *const *src_arrmeta,
                                          kernel_request_t kernreq, const eval::eval_context *ectx,
...
intptr_t nd::take_ck::instantiate(char *DYND_UNUSED(static_data), size_t DYND_UNUSED(data_size),
                                  ...
                                  const std::map<std::string, ndt::type> &tp_vars)
{
  ...
  if (mask_el_tp.get_type_id() == bool_type_id) {
    return nd::masked_take_ck::instantiate(NULL, 0, NULL, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp,
                                           src_arrmeta, kernreq, ectx, nkwd, kwds, tp_vars);
  } else if (mask_el_tp.get_type_id() == (type_id_t)type_id_of<intptr_t>::value) {
    return nd::indexed_take_ck::instantiate(NULL, 0, NULL, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp,
                                            src_arrmeta, kernreq, ectx, nkwd, kwds, tp_vars);
  } else {
    stringstream ss;
