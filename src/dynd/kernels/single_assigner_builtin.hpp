...
struct single_assigner_builtin_base_error {
    static void assign(dst_type *DYND_UNUSED(dst), const src_type *DYND_UNUSED(src), ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(dst_type *dst, const src_type *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(dst_type *dst, const std::complex<src_real_type> *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(float *dst, const std::complex<src_real_type> *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(double *dst, const std::complex<src_real_type> *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(dynd_bool *dst, const src_type *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<dst_real_type> *dst, const src_type *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(float *dst, const double *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
        DYND_TRACE_ASSIGNMENT(static_cast<float>(*src), float, *src, double);
...
{
    static void assign(std::complex<float> *dst, const std::complex<double> *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(real_type *dst, const std::complex<real_type> *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<float> *dst, const double *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<real_type> *dst, const real_type *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<double> *dst, const float *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(double *dst, const std::complex<float> *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(float *dst, const std::complex<double> *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
        std::complex<double> s = *src;
        float d;
...
{
    static void assign(same_type *dst, const same_type *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
        *dst = *src;
    }
};
