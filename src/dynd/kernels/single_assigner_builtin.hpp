...
{
    static void assign(dst_type *dst, const src_type *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
...
{
    static void assign(dst_type *dst, const std::complex<src_real_type> *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
...
{
    static void assign(dynd_bool *dst, const src_type *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
        src_type s = *src;
...
{
    static void assign(std::complex<dst_real_type> *dst, const src_type *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
        src_type s = *src;
...
{
    static void assign(real_type *dst, const std::complex<real_type> *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<real_type> *dst, const real_type *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<double> *dst, const float *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
...
{
    static void assign(double *dst, const std::complex<float> *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
...
{
    static void assign(float *dst, const std::complex<double> *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
        std::complex<double> s = *src;
        float d;
...
{
    static void assign(std::complex<float> *dst, const double *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
        double s = *src;
        float d;
...
{
    static void assign(same_type *dst, const same_type *src, unary_kernel_static_data *DYND_UNUSED(extra)) {
        *dst = *src;
    }
};
