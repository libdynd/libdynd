...
{
    static void assign(dst_type *dst, const std::complex<src_real_type> *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
...
{
    static void assign(float *dst, const double *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<float> *dst, const std::complex<double> *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
...
{
    static void assign(real_type *dst, const std::complex<real_type> *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<real_type> *dst, const real_type *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
...
{
    static void assign(std::complex<double> *dst, const float *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
...
{
    static void assign(double *dst, const std::complex<float> *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
...
{
    static void assign(float *dst, const std::complex<double> *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
        std::complex<double> s = *src;
        float d;
...
{
    static void assign(same_type *dst, const same_type *src, hierarchical_kernel_common_base *DYND_UNUSED(extra)) {
        *dst = *src;
    }
};
