...
{
    static void assign(dynd_bool *dst, const dynd_float16 *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
...
{
    static void assign(dynd_float16 *dst, const dynd_bool *src, ckernel_data_prefix *DYND_UNUSED(extra)) {
        // DYND_TRACE_ASSIGNMENT((bool)(!s.iszero()), dynd_bool, s, dynd_float16);
...
{ \
    static void assign(dynd_float16 *dst, const src_type *src, ckernel_data_prefix *DYND_UNUSED(extra)) { \
        float tmp; \
...
{ \
    static void assign(dst_type *dst, const dynd_float16 *src, ckernel_data_prefix *DYND_UNUSED(extra)) { \
        float tmp = float(*src); \
