...
static dynd_type_range sparse_type_parameter(dynd_type_header_impl *type_header) noexcept {
  dynd_type **child_ptr = sparse_get_parameter(type_header);
  return {child_ptr, child_ptr + 1u};
}

static dynd_size_t sparse_alignment(dynd_type_header_impl *type_header) noexcept {
  dynd_type **child_ptr = sparse_get_parameter(type_header);
