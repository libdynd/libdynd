...
fixed_bytes_type::fixed_bytes_type(intptr_t data_size, intptr_t data_alignment)
...
fixed_bytes_type::~fixed_bytes_type()
{
}

void fixed_bytes_type::get_bytes_range(const char **out_begin, const char**out_end,
...
void fixed_bytes_type::print_data(std::ostream& o, const char *DYND_UNUSED(arrmeta), const char *data) const
{
...
bool fixed_bytes_type::is_lossless_assignment(const ndt::type& dst_tp, const ndt::type& src_tp) const
{
...
bool fixed_bytes_type::operator==(const base_type& rhs) const
{
    if (this == &rhs) {
        return true;
...
intptr_t fixed_bytes_type::make_assignment_kernel(
        ...
        switch (src_tp.get_type_id()) {
            case fixed_bytes_type_id: {
                ...
                if (get_data_size() != src_fs->get_data_size()) {
                    throw runtime_error("cannot assign to a fixed_bytes type of a different size");
                }
