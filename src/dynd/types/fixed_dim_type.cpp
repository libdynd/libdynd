...
bool fixed_dim_type::matches(const char *arrmeta, const ndt::type &other,
  ...
  case fixed_dim_type_id:
    return get_fixed_dim_size() ==
           ...
           m_element_tp.matches(arrmeta,
                                other.extended<fixed_dim_type>()->m_element_tp,
                                tp_vars);
  case cfixed_dim_type_id:
    return arrmeta != NULL &&
           get_fixed_dim_size() ==
           ...
           m_element_tp.matches(
               arrmeta, other.extended<cfixed_dim_type>()->get_element_type(),
               tp_vars);
  default:
    return false;
  }
