...
intptr_t cstruct_type::make_assignment_kernel(
    const arrfunc_type_data *self, const arrfunc_type *af_tp, void *ckb, intptr_t ckb_offset,
...
size_t cstruct_type::make_comparison_kernel(
    void *ckb, intptr_t ckb_offset, const ndt::type &src0_tp,
