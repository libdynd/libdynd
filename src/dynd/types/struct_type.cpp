...
size_t ndt::struct_type::get_elwise_property_index(const std::string &property_name) const
{
...
ndt::type ndt::struct_type::get_elwise_property_type(size_t elwise_property_index, bool &out_readable,
...
size_t ndt::struct_type::make_elwise_property_getter_kernel(void *ckb, intptr_t ckb_offset, const char *dst_arrmeta,
...
size_t ndt::struct_type::make_elwise_property_setter_kernel(void *DYND_UNUSED(ckb), intptr_t DYND_UNUSED(ckb_offset),
