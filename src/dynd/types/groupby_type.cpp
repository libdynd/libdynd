...
void ndt::groupby_type::get_dynamic_array_properties(const std::pair<std::string, gfunc::callable> **out_properties,
                                                     size_t *out_count) const
{
  static pair<std::string, gfunc::callable> groupby_array_properties[] = {
