...
intptr_t ellipsis_dim_type::get_dim_size(const char *DYND_UNUSED(metadata),
                                        const char *DYND_UNUSED(data)) const
{
    return -1;
}
...
void ellipsis_dim_type::metadata_default_construct(
...
void ellipsis_dim_type::metadata_copy_construct(
...
size_t ellipsis_dim_type::metadata_copy_construct_onedim(
    char *DYND_UNUSED(dst_metadata), const char *DYND_UNUSED(src_metadata),
    memory_block_data *DYND_UNUSED(embedded_reference)) const
{
    throw type_error("Cannot store data of ellipsis type");
...
void ellipsis_dim_type::metadata_destruct(char *DYND_UNUSED(metadata)) const
{
    throw type_error("Cannot store data of ellipsis type");
}
