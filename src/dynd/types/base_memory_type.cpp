...
void ndt::base_memory_type::print_data(std::ostream &o, const char *arrmeta,
                                       const char *data) const
{
  m_element_tp.print_data(o, arrmeta + m_storage_arrmeta_offset, data);
}

void ndt::base_memory_type::get_shape(intptr_t ndim, intptr_t i,
...
void ndt::base_memory_type::get_strides(size_t i, intptr_t *out_strides,
...
void
ndt::base_memory_type::get_vars(std::unordered_set<std::string> &vars) const
{
  m_element_tp.get_vars(vars);
}

ndt::type ndt::base_memory_type::apply_linear_index(
...
intptr_t ndt::base_memory_type::apply_linear_index(
...
ndt::type ndt::base_memory_type::at_single(intptr_t i0,
...
ndt::type
ndt::base_memory_type::get_type_at_dimension(char **inout_arrmeta, intptr_t i,
...
bool ndt::base_memory_type::is_lossless_assignment(const type &dst_tp,
...
void ndt::base_memory_type::transform_child_types(
...
void ndt::base_memory_type::arrmeta_default_construct(char *arrmeta,
...
void ndt::base_memory_type::arrmeta_copy_construct(
